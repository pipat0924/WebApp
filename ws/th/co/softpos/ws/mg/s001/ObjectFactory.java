 ...
 * generated in the th.co.softpos.ws.mg.s001 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Process_QNAME = new QName("http://s001.mg.ws.softpos.co.th/", "process");
    private final static QName _ProcessResponse_QNAME = new QName("http://s001.mg.ws.softpos.co.th/", "processResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: th.co.softpos.ws.mg.s001
     * 
     */
    ...
    /**
     * Create an instance of {@link RsData }
     * 
     */
    public RsData createRsData() {
        return new RsData();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://s001.mg.ws.softpos.co.th/", name = "process")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://s001.mg.ws.softpos.co.th/", name = "processResponse")
