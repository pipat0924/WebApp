    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">บันทึกคำร้องขอปรับลดหนี้</li>
            </ol>
            <div class="row">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="col-md-6">
                                            <div class="form-inline">
                                                <!--<div class="form-group">-->
                                                <label >เหตุผลการปรับลดหนี้* :</label>
            ...
            <div class="row">
                <div class="col-md-12 tab-modefile">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class=""><a href="#tab-2-1" aria-controls="tab-2-1" role="tab" data-toggle="tab">รายละเอียดการขอปรับลดหนี้</a></li>
                        <li role="presentation" class="active"><a href="#tab-2-2" aria-controls="tab-2-2" role="tab" data-toggle="tab">เอกสารแนบพร้อมรับรองสำเนาถูกต้อง</a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <label>
                                                        &nbsp;<input type="checkbox"> ต้นฉบับใบเสร็จรับเงิน/ใบกำกับภาษี
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <label>
                                                        &nbsp;<input type="checkbox"> สำเนาบัตรประชาชน/หนังสือรับรองการจดทะเบียนนิติบุคคล (ไม่เกิน 6 เดือน)
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <label>
                                                        &nbsp;<input type="checkbox"> สำเนาบัตรประชาชนของผู้มอบอำนาขและผู้รับมอบอำนาจ
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <label>
                                                        &nbsp;<input type="checkbox"> หนังสือมอบอำนาจ (ถ้ามี)
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <label>
                                                        &nbsp;<input type="checkbox"> สำเนาสมุดบัญชีเงินฝากธนาคาร (กรณีรับเงินคืน โดยการโอนเข้าบัญชีธนาคาร)
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
