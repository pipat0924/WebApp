...
<html>
    ...
    <body>
        ...
        <section class="container-fluid menu">
				          ...
				          <thead>
					          <tr>
				                  ...
				                  <th data-align="center" data-field="shopNo" data-sortable="true">รหัสสถานที่รับชำระ</th>
				                   ...
				                   <th data-align="center" data-field="posName" data-sortable="true">ชื่อเครื่องที่รับชำระ</th>
				                   ...
				                   <th data-align="center" data-field="" data-sortable="true">Total</th>
            ...
            <form action="../printUnCloseEndOfDayReport.xls" method="post" target="_printForm">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="toDate" name="toDate"/>
            	<input type="hidden" id="period" name="period"/>
