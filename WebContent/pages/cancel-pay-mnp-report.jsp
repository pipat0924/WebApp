    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานการยกเลิกการรับชำระเงิน (MNP)</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">ข้อมูลการยกเลิกการรับชำระเงิน (MNP)</div>
                    			...
                    			<form id=documentReportForm method="post" class="form-horizontal" role="form">
									<div class="form-group">
                                      ...
                                      <div class="form-group">
										...
										<label class="control-label col-sm-3" style="width:8%">เจ้าหน้าที่:</label>
										<div class="col-sm-3" style="width:22%">
											<select class="form-control" id="officer" name="officer"></select>
										</div>
										<div class="col-sm-1" style="margin-left:17%">
			            ...
			            <table id="CancelPaymentReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="left" data-field="accountNo" data-sortable="true"> Order Id</th>
            ...
            <form action="../printCancelPaymentReport.pdf" method="post" target="_printForm">
            	...
            	<input type="hidden" id="sourceType" name="sourceType" value="all" />
            	<input type="hidden" id="serviceType" name="serviceType" value="MNP"/>
            </form>
