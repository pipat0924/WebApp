        ...
        function setup(array, v) {
            ...
            $.each(array,function(i,o){
                if(o.category == 'reason.cancel.payment') {
                    ...
                    obj.elem.append('<option data-index="'+ i +'" data-key="'+ o.id +'" value="'+ o.key +'">'+ o.value +'</option>')
                }
            });
        }
...
// 	self.buttonSearchReceiptList = new Button("#buttonSearchReceiptList");
	...
	self.inputCancelReasonType = new DropDown("#cancelReasonType").initV3("../MasterData/findByGroupKeyAndRoleOutDay.json","CANCEL_REASON_REQ");//.data([{ key: "", value: "- กรุณาเลือกระบุเหตุผลการยกเลิก -"}, { key: "wrongName", value: "ชื่อ-ที่อยู่ ไม่ถูกต้อง"},{ key: "wrongInvoice", value: "ผิดใบแจ้งค่าใช้บริการ" }]);
