...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <div class="row">
	        <div class="col-md-12 tab-modefile">
	        	<ol class="breadcrumb" id="breadcrumb">
                    ...
                    <li>ค้นหาชำระค่าหนี้สูญ</li>
                    <li>ระบุเหตุผลยกเลิกรับชำระค่าหนี้สูญ</li>
                    <li class="active">สรุปการยกเลิกรับชำระค่าหนี้สูญ</li>
	    ...
	    <ul class="list-inline pull-right hide" id="panelNavigation4">
	        <li><a id="addCancelReceiptList" href="cancel-tboss-charge_1.jsp?new" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปยกเลิกรับชำระหนี้สูญ</a></li>
	    </ul>
...
function buttonCancelReceiptListClickEvent() {
	...
	$.each(view.tableCancelReceiptList3.rawData(), function(i,o){
		...
		params["receipts["+ i +"].reasonCode"] = o.no;
		params["receipts["+ i +"].reasonDesc"] = o.no;
	});
	view.buttonCancelReceiptList.showLoad();
	post("../cancelPaymentTBOSS.json", params, function(res){
