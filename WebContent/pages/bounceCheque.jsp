        ...
        <section class="container-fluid menu">
            ...
            <%-- <%@include  file="menu.jsp" %> --%>
                <form id="bounceChequeForm" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="row">
                        <div class="tableBounce">
                            <div class="col-md-12">
                                <div class="control-label col-sm-12">
                                    <a id="save" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-download-alt"></span> โอนหนี้กลับ</a>
                                    <a id="saveagain" class="btn btn-primary" onclick="x2x()"><span class="glyphicon glyphicon-download-alt"></span> บันทึก</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div id="bouncePanel" class="tableBounce">
                            <div class="col-md-12 tab-modefile">
                                        ...
                                        <table id="invoiceList" data-maintain-selected="true" class="table table-hover" data-toggle="table" data-detail-view="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="value" data-align="center" data-sortable="true">สถานะ</th>
                                                    <th data-field="bounceStatus" data-align="center" data-sortable="true">สถานะเช็ค</th>
    ...
    <script type="text/javascript">
        var view = (function ($) {
            ...
            self.input = new (function () {
                ...
                that.billNo = new Input("#billNo", 30);
        ...
        function xxx() {
            ...
            if ($("#invoiceNo").val() == "" && $("#billNo").val() == "" && $("#chequeNo").val() == "") {
                view.dialog.advanceSearchMessageDialog.error(["กรุณากรอกข้อมูลการค้นหา"]).show(); return;
            } else {
                view.dialog.advanceSearchMessageDialog.hide();
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        view.table.invoiceList.rawData($.map(res.checkBounceChequeDTOList, function (o, i) {
                            return {
                                "bounceDate": o.bounceDate,
                                "creBillDate": o.creBillDate,
                                "billNo": o.billNo,
                                "chequeNo": o.chequeNo,
                                "payLocation": o.payLocation,
                                "user": o.user,
                                "dueDate": o.dueDate,
                                "useDate": o.useDate,
                                ...
                                "vat": o.vat,
                                "value": o.masterDataDTO.value,
                                "bounceStatus": "",
                                "remark": o.remark,
                                "bounceCheque": o.bounceCheque
        ...
        function x2x() {
            ...
            for (var rowid = 0; rowid < data.length; rowid++) {
                ...
                if (checked) {
                    console.log("come");
                    for (var i = 0; i < testXXX.checkBounceChequeDTOList.length; i++) {
                        if (testXXX.checkBounceChequeDTOList[i].billNo === data[rowid].billNo) {
                            console.log("555555555");
                            checkBounceChequeList.push(testXXX.checkBounceChequeDTOList[i]);
                        }
                    }
                    // checkBounceChequeList.push(data[rowid]);
                } else {
                    console.log("No");
                }
            }

            bounceChequeDTO = { "checkBounceChequeDTOList": checkBounceChequeList };

            $.ajax({
                type: "POST",
                url: "../updateCheckBounceCheque",
                data: JSON.stringify(bounceChequeDTO),
                dataType: "json",
                async: false,
                contentType: "application/json; charset=utf-8",
