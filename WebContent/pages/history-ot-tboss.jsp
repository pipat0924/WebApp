...
//                 }
        ...
        view.tab.invoiceDetailsTab.init(0, function () {
            ...
            view.table.invoiceList.showLoad();
             $.get("../searchInvoiceOTBOSS.json", { "invNo": billNoSelected , "source" : "OTBOSS" }, function (res) {
                 		view.table.invoiceList.showLoad();
        ...
        view.tab.invoiceDetailsTab.init(1, function () {
            ...
            $.get("../findPaymentTbossHistory.json", { "billingNo": billNoSelected }, function (res) {
        ...
        view.tab.invoiceDetailsTab.init(2, function () {
            ...
            $.get("../searchottbossdetails.json", { "account": billNoSelected , "source" : "OTBOSS" }, function (res) {
