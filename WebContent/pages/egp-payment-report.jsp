...
<html>
    <head>
        <title>รายงานรับชำระเงิน บช.1</title>
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                    	<li><i>รายงานการรับชำระเงิน บช.1</i></li>
                        <li class="active"><i>รายงานการรับชำระเงิน บช.1</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานการรับชำระเงิน บช.1</div>
...
<!-- 				                   <th data-align="right" data-field="discount" data-sortable="true" data-formatter="currencyFormatter">ส่วนลด</th> -->
            ...
            <form action="../printEgpPaymentReport.xls" method="post" target="_printForm1">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="endDate" name="endDate"/>
            	<input type="hidden" id="accountID" name="accountID"/>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		...
            		document.forms[1].vatRate.value = $("#vatRate option:selected").val();
            		...
            		document.forms[2].vatRate.value = $("#vatRate option:selected").val();
