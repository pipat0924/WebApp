...
<html>
    <head>
        <title>รายงานสรุปการรับชำระเงิน (ตัวแทนรับชำระ)</title>
									...
									<div class="form-group">
										...
										<div class="col-md-2">
										  <select class="form-control" id="payCase" name="payCase">
										    ...
										    <option data-index="0" data-key="1" value="1">เงินสด</option>
										    <option data-index="1" data-key="2" value="2">เช็ค</option>
										    <option data-index="2" data-key="3" value="3">บัตรเครดิต</option>
										    <option data-index="3" data-key="4" value="4">ธนาณัติ</option>
										    <option data-index="4" data-key="5" value="5">ตั๋วแลกเงิน</option>
										    <option data-index="5" data-key="6" value="6">คูปอง</option>
										    <option data-index="6" data-key="7" value="7">โอนเงินในประเทศ</option>
										    <option data-index="7" data-key="8" value="8">offset</option>
										  </select>
										</div>
                                      </div>
                                      <div class="form-group">
			            ...
			            <table id="SummaryDailyPaymentReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="right" data-field="receiptCount" data-sortable="true" data-formatter="numberFormatter">จำนวนรายการ</th>
            ...
            <script type="text/javascript">
            	...
            	var view = (function($){
            		...
            		function setup(array) { 
            			...
            			var tempOfficer = '${epContext.userCode}';
