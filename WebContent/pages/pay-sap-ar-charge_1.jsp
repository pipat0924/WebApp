		...
		<form id="payServiceChargeForm" method="post" class="form-horizontal"
			...
			<div class="row">
				<div class="col-md-12 tab-modefile">
					<ol class="breadcrumb">
						<li><i>รับชำระค่าบริการลูกหนี้รายตัว (SAP-AR)</i></li>
								...
								<div class="col-md-12">
									<div class="form-horizontal">
										<div class="form-group">
											...
											<label class="control-label col-sm-2">Barcode /
												QRcode :</label>
											<div class="col-sm-2">
											...
											<div class="col-sm-2">
												<a id="test_sap" class="btn btn-primary"
													> TestSap</a>
													<a id="test_view" class="btn btn-primary"
													> TestView</a>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
        ...
        var view = (function ($) {
            ...
            self.button = new (function () {
                ...
                that.test_sap = new Button("#test_sap");
                that.test_view = new Button("#test_view");
...
//                 }
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        view.input.customerName.val(res.data[0].customer_name);
                        ...
                        view.custInfoInputCurrencyCode.val(res.data[0].currency_paid);
        ...
        view.tab.invoiceDetailsTab.init(0, function () {
            ...
            $.get("../searchottboss.json", { "no": billNoSelected }, function (res) {
                 		view.table.invoiceList.showLoad();
        ...
        function invoiceListMapper(o) {
            var isStateAgency = view.inputCustomerSegment.key() == "2";
            var BeforeVat = o.total_amount_ar - o.vat_amount_ar;
            var deduct = BeforeVat * 0.03; // คำนวณจากตรงนี้นะครับ
            ...
            var mount = datePeoiud.substring(4);
            ...
            return {
                ...
                , "vat": stripToNumberWithFormat(o.vat_amount_ar)
                , "vatRate": stripToNumberWithFormat((o.vat_rate_ar || "0"))
                , "totalCharge": stripToNumberWithFormat(o.total_amount_ar)
                , "balanceDue": stripToNumberWithFormat(o.total_amount_ar)
        ...
        function invoiceServiceFormatter(val, row, ind) {
            ...
            $.get("../findProductOTBOSS.json", {"accountNo": row.accountNo, "nobil": row.invoiceNo}, function (res) {
        ...
        // function test 
   $(document).ready(function() {
    $("#test_sap").click(function() {
    	var url = "../findtest_sap.json";
   	 $.ajax({
            type: "POST",
            async: false,
            url: url,
