...
<html>
<head>
    <title>รายงานค่าต่อ/ค่าปรับ</title>
...
<section class="container-fluid menu">
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li><i>รายงาน</i></li>
                <li class="active"><i>รายงานค่าต่อ/ค่าปรับ</i></li>
            </ol>
            <div class="panel panel-default">
                <div class="panel-heading">รายงานค่าต่อ/ค่าปรับ</div>
                        ...
                        <div class="col-md-12">
                            <form id=documentReportForm method="post" class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" style="width: 12.6%;">เลขที่ใบเสร็จรับเงิน:</label>
                                    <div class="col-sm-3" style="width:17%">
                                        <input type="text" class="form-control" id="receiptNo" name="receiptNo" value="">
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <form action="../printPnExtDailyPaymentReport.pdf" method="post" target="_printForm">
        ...
        <input type="hidden" id="serviceType" name="serviceType" value="PNEXT"/>
    </form>
    <form action="../printPnExtDailyPaymentReport.xls" method="post" target="_printForm1">
        <input type="hidden" id="printPdf" name="printPdf" value="1"/>
        <input type="hidden" id="startDate" name="startDate"/>
        <input type="hidden" id="endDate" name="endDate"/>
        <input type="hidden" id="receiptNo" name="receiptNo"/>
    ...
    <script type="text/javascript">
        $(document).on("click", "a#inquiryReport", function() {
            $("#DailyPaymentReport").bootstrapTable("refresh",
                    { url: "../getPnExtDailyPaymentReport.json?printPdf=0"
                    ...
                    +"&receiptNo="+$("#receiptNo").val().replace(/ /g, '')
            ...
            document.forms[1].receiptNo.value = $("#receiptNo").val();
            ...
            document.forms[2].receiptNo.value = $("#receiptNo").val().replace(/ /g, '');
