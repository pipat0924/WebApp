...
<html>
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12 tab-modefile">
                	<ol class="breadcrumb">
                        <li><i>ประวัติการรับชำระตัวแทน</i></li>
	    ...
	    <ul id="panelNavigation2" class="list-inline pull-right hide">
	        <li><a id="buttonSearchReceiptList" href="cancel-agent-charge_1.jsp" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปเพิ่มรายการ</a></li>
		...
		<div class="row hide" id="panelCancelReceiptList2">
			<div class="col-md-12 tab-modefile">
                    ...
                    <table id="tableCancelReceiptList2" data-toggle="table" data-detail-view="false" data-detail-formatter="invoiceDetailsFormatter">
                        <thead>
                            <tr>
                             <th data-align="center" data-formatter="runningFormatter">#</th>
                             <th data-field="no" data-align="center">เลขที่ใบเสร็จรับเงิน</th>
...
function buttonSearchClickEvent() {
	var params = { "payType": "AGENT" }, service;
	view.message.clear();
	     if (!view.inputSearchCustomerNo.isEmpty()) { service = "cusNo-payType"; params["cusNo"] = view.inputSearchCustomerNo.val() }
