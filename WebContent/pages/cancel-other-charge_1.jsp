...
<html>
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12 tab-modefile">
                	<ol class="breadcrumb">
                        <li><i>ยกเลิกชำระค่าบริการอื่นๆ</i></li>
                        <li class="active">ค้นหาชำระค่าบริการอื่นๆ</li>
                        <li>ระบุเหตุผลชำระค่าบริการอื่นๆ</li>
                        <li>สรุปการยกเลิกรับชำระอื่นๆ</li>
                        <li>ผลการยกเลิกรับชำระอื่นๆ</li>
                    </ol>
                    <div id="message"></div>
		                                ...
		                                <div class="col-md-12">
		                                    <div class="form-horizontal">
		                                        <div class="form-group">
		                                            ...
		                                            <div class="col-sm-2">
		                                                <input class="form-control" id="inputSearchCustomerNo">
		                                            </div>
		                                            ...
		                                            <div class="col-sm-4">
		                                            <button class="btn btn-primary" id="buttonSearch"><span class="glyphicon glyphicon-search"></span> ค้นหา</button>&nbsp;&nbsp;
            ...
            <ul class="list-inline pull-right hide" id="panelNavigation1">
                <li><a id="addCancelReceiptList" class="btn btn-link"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มรายการการยกเลิก</a></li>
                <%--<li><a id="sumCancelReceiptList" href="cancel-other-charge_3.jsp" class="btn btn-link"><span class="glyphicon glyphicon-th-list"></span> สรุปรายการการยกเลิก</a><span class="badge badge_modefil">0</span></li>--%>
            </ul>
            <div class="row hide" id="panelCancelReceiptList1">
	                    ...
	                    <div role="tabpanel" class="tab-pane active" id="tab-2-1">
	                        <table data-toggle="table" id="tableCancelReceiptList1" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
	                            <thead>
	                                <tr>
	    ...
	    <ul id="panelNavigation2" class="list-inline pull-right hide">
	        <%--<li><a id="buttonSearchReceiptList" href="cancel-other-charge_1.jsp" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปเพิ่มรายการ</a></li>--%>
		...
		<div class="row hide" id="panelCancelReceiptList2">
			<div class="col-md-12 tab-modefile">
                    ...
                    <table id="tableCancelReceiptList2" data-toggle="table" data-detail-view="false" data-detail-formatter="invoiceDetailsFormatter" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
                        <thead>
                            <tr>
                             <th data-align="center" data-formatter="runningFormatter">#</th>
                             <th data-field="no" data-align="center">เลขที่ใบเสร็จรับเงิน</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="tab-modefile">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">ข้อมูลลูกค้า</a></li>
                        </ul>
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="profile">
                                        <div class="form-horizontal">
											<div class="form-group">
												...
												<div class="col-sm-3"><input class="form-control" id="advSrcCusNo" value="700005*"></div>
...
/*function AuthenticationDialog(succFunc, failFunc, url, title, usrLabel, pwdLabel, okBtn, cnBtn) { var obj = this, httpUrl = url, done = succFunc, fail = failFunc, cancel = function(){}, inputs; obj.el = "modal_authentication";
	...
	obj.done = function(func) { done = func; return this }; obj.fail = function(func) { fail = func; return this }; obj.cancel = function(func) { cancel = func; return this }
     ...
     function AuthenticationDialog(succFunc, failFunc, url, title, usrLabel, pwdLabel, okBtn, cnBtn) { var obj = this, httpUrl = url, done = succFunc, fail = failFunc, cancel = function(){}, inputs; obj.el = "modal_authentication";
        ...
        var btnCN = '<button type="button" class="btn btn-danger" data-dismiss="modal"><span class="glyphicon glyphicon-remove-circle"></span> '+ (cnBtn || "Cancel") +'</button>';
        obj.elem = $(document.body).append('<div class="modal fade" role="dialog" data-backdrop="static" id="'+ obj.el +'"><div class="modal-dialog"><div class="modal-content"><div class="modal-header">'+ hdrCS + hdrTT +'</div><div class="modal-body">'+ divMG + content +'</div><div class="modal-footer">'+ btnOK + btnCN +'</div></div></div></div>').find("#"+ obj.el); inputs = obj.elem.find("input").keyup(function(e){ var key = (e.which || e.keyCode || e.charCode || 0); if (key != 13) return true; obj.elem.find("input, button").eq(e.target.type == "text" ? 2 : 3).focus(); return true }); buttons = obj.elem.find("button");
        buttons.eq(1).on({ click: function(){ $("#userAuthen").val($("#userName").val()); console.log($("#userName").val()+" <<<>>> "+inputs.eq(0).val()+" <<<>>> "+inputs.eq(1).val()); $.post(httpUrl, { username: inputs.eq(0).val(), password: inputs.eq(1).val() }, function(res){ if (!res || res.statusCode != "0") { obj.elem.find(".alert").text("You don't have permission to access this feature. Please contact to Administration for more information.").removeClass("hide"); fail(res); return; } done(res); obj.hide() }) } }).end().filter(function(index){ return index == 0 || index == 2 }).on({ click: function(){ cancel() } })
        obj.url = function(url){ httpUrl = url; return this }; obj.show = function(){ obj.elem.modal("show"); obj.elem.find("div.alert").addClass("hide").text(""); inputs.val(""); return this }; obj.hide = function(){ obj.elem.modal("hide"); return this }
        obj.done = function(func) { done = func; return this }; obj.fail = function(func) { fail = func; return this }; obj.cancel = function(func) { cancel = func; return this }
    } //comment09-08-2017
    ...
    function DropDown(el, url) { var obj = this, data = [{ key: "", value: "", text: "Please Select" }]; obj.el = el; obj.elem = $(el);
        ...
        function setup(array, v) {
            ...
            $.each(array,function(i,o){
                if(o.category == 'reason.cancel.payOther') {
...
function BootstrapTable(el, options) { var obj = this, rawData = [], successFunc = function(){}, checkEvt = function(e){ console.log(e) }, uncheckEvt = checkEvt; obj.el = el; obj.elem = $(el).bootstrapTable(options = $.extend({ uniqueId: "id", responseHandler: function(res){ if (!res) return []; if (res.constructor === Array) return res; if (!res.data || res.data.constructor !== Array) return []; return res.data }, onLoadSuccess: function(res){ rawData = res; obj.resetView(400); successFunc(res) }, onCheck: window[el.substring(1) +"CheckEvent"], onUncheck: window[el.substring(1) +"UncheckEvent"], onCheckAll: window[el.substring(1) +"CheckAllEvent"], onUncheckAll: window[el.substring(1) +"UncheckAllEvent"] }, options));
	...
	this.inputSearchCustomerNo = new Input("#inputSearchCustomerNo");
	this.inputSearchReceiptNo = new Input("#inputSearchReceiptNo");
	self.inputCancelReasonType = new DropDown("#cancelReasonType").init("../getReasonCancelPayOther.json");//.data([{ key: "", value: "- กรุณาเลือกระบุเหตุผลการยกเลิก -"}, { key: "wrongName", value: "ชื่อ-ที่อยู่ ไม่ถูกต้อง"},{ key: "wrongInvoice", value: "ผิดใบแจ้งค่าใช้บริการ" }]);
...
var newReceiptList, userParam= {}, flgNewReceipt = false, accountName = "", addr = "";// by maew
function customerTypeFormatter(val, row, ind) { return val.toLowerCase() == "organization" ? "นิติบุคคล" : "บุคคลธรรมดา" }
function serviceTypesFormatter(val, row, ind) { return $.map(val, function(service){ return (view.payothersServiceNames[service.serviceName])? view.payothersServiceNames[service.serviceName].descFullTh : service.serviceName  }).join(", ") }
...
function buttonSearchClickEvent() {
	var url = "", params = {};
	view.message.clear();
	var ss = inputSearchCustomerNo.val();
	var sss = inputSearchReceiptNo.val();
	     if (!view.inputSearchCustomerNo.isEmpty() || !view.inputSearchReceiptNo.isEmpty() ) {url = "../invPayTypeCancelOther.json";    params= { "invNo" : view.inputSearchCustomerNo.val(),"receiptNo" : view.inputSearchReceiptNo.val(),  "payType": "OTHER" }  }
	else { view.message.error(["กรุณากรอกข้อมูล หมายเลขลูกค้า หรือ หมายเลขใบเสร็จก่อน"]).show(); return; }
...
function buttonProceedReceiptListClickEvent() {
   ...
   /*  var reason = $("#cancelReasonType :selected").html();
    var chkReason = $("#cancelReasonType :selected").val();
    var editUserHTML = '<div id="editUserAddress"><hr><h4 class="modal-title"><span class="glyphicon glyphicon-pencil"></span> Edit User Detail</h4><hr><form> <div class="form-group"> <label for="name" class="control-label">Name: </label> <input class="form-control" id="editName"> </div> <div class="form-group"> <label class="control-label">Address: </label> <textarea class="form-control" id="editAddress"></textarea></div></form></div>';
    var flgNewReceipt = false;
    if(chkReason == '001'){
        flgNewReceipt = true;
        if (!flg) {
            $("body #modal_authentication .modal-body").append(editUserHTML);
            $("#editName").val(receiptSelect[0].accountName);
            $("#editAddress").val(receiptSelect[0].addrLine1);
            flg = true;
        }
    } else {
        $("body #modal_authentication #editUserAddress").remove();
        flg = false;
    } */
    ...
    /* view.dialogAuthentication.show().done(function () {
        ...
        for (var i = 0, m = receiptList.length; i < m; i++) {
            ...
            receiptList[i]["cancelReasonCode"] = $("#cancelReasonType :selected").val();//data.key;
            receiptList[i]["cancelReasonDesc"] = $("#cancelReasonType :selected").html();
            if ("001" == $("#cancelReasonType :selected").val()) {
                receiptList[i]["accountName"] = $("#editName").val();
                receiptList[i]["addrLine1"] = $("#editAddress").val();
            }
        ...
        location.href = "cancel-other-charge_3.jsp";
    }); */
	...
	/*view.dialogAuthentication.show().done(function(){
	 	...
	 	view.session("cancelList", cancelList.concat(receiptList));
	 	view.session("payothersServiceNames", view.payothersServiceNames);
        view.session("userAuthen", $("#userAuthen").val());
		location.href = "cancel-other-charge_3.jsp";
	});*/
}
...
$(function(){
    ...
    $('#cancelReasonType').on('click', function () {
        var chkReason = view.inputCancelReasonType.key();//$("#cancelReasonType :selected").val();
