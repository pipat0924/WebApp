               ...
               <ul class="nav nav-tabs" role="tablist" id="tabDetails-tab">
				...
				<form id="payServiceChargeForm" method="post" class="form-horizontal" role="form">
									...
									<div class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-lg-4">
			                                    ...
			                                    <div class="col-sm-8"><input type="text" class="form-control" id="inputDesc"></div>
			                                </div>
				 ...
				 <div class="col-sm-12 text-right" style="margin-bottom: 10px;">
					 <button type="button" id="btnAddMenu" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> เพิ่ม</button>
	            	...
	            	<div class="table-responsive">
			              ...
			              data-height="300">
							            ...
							            <tr>
							                ...
							                <th data-field="name">ชื่อเมนู</th>
							                <th data-field="desc">รายละเอียด</th>
							                <th data-field="type">ชนิดเมนู</th>
							                <th data-field="refName">จากเมนูหลัก</th>
...
var view = (function($){
        ...
        for (var i = 0; i < arguments[0].length; i++) {
            ...
            obj.elem.bootstrapTable('insertRow', {
                ...
                row: {
                    ...
                    name: dataObj.name,
                    desc: dataObj.desc,
                    type: dataObj.parrentId == 0 ? 'เมนูหลัก' : 'เมนูย่อย',
                    refName: dataObj.parrentId == 0 ? '-' : dataObj.mainMenuName,
    ...
    self.tableMenu = new BootstrapTable("#tableMenu");
    self.buttonSearch = new Button("#btnSearch");
    self.buttonAddMenu = new Button("#btnAddMenu");
	...
	$(function() {
		view.sessionUnset('epis-master-menu');
	...
	function btnSearchClickEvent(){
		...
		view.tableMenu.removeAll();
		view.tableMenu.showLoad();
		
		var reqObj = "name="+name+"&desc="+desc;
			
		 $.ajax({
             type: "GET",
             url: "../findMenuListByNameAndDesc.json?"+reqObj,
             dataType: "json",
             contentType: "application/x-www-form-urlencoded;charset=utf-8",
             success:function(data){
                 console.log(data.data);//data array
                 view.tableMenu.hideLoad();
                 if(data.statusCode==0)
                 	view.tableMenu.addRowMenu(data.data);
                 else{
	...
	function deleteMenu(dataId){
		  ...
		  $.ajax({
             ...
             success:function(data){
                 ...
                 if(data.statusCode==0){
                 	...
                 	var idArr = data.data.split('||');
                 	for(var i = 0;i<idArr.length;i++){
                 		view.tableMenu.remove(parseInt(idArr[i]));	
                 	}
		...
		function redirectPage(index,value){
			if(index==1) view.session('epis-master-menu',value);
			//else if(index ==2) 
			window.location.href = "epis-master-menu_2.jsp";
