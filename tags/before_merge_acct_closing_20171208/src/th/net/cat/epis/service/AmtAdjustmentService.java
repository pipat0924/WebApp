...
public class AmtAdjustmentService {
	...
	@Transactional
	public AmountAdjustmentHeader createAmountAdjustment(AmountAdjustmentHeader aah , List<AmountAdjustment> aal, List<AmountAdjustmentDetail> aadl) {
