    ...
    <body>
        ...
        <section class="container-fluid menu">
		                                ...
		                                <div class="col-md-12">
		                                    <div class="form-horizontal">
		                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <button id="search" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> ค้นหา</button>&nbsp;&nbsp;</div>
		                                          </div>
		                                    </div>
		                                </div>
		                            </div>
            ...
            <ul class="hide list-inline pull-right" id="panelNavigation1">
                <li><a id="addCancelReceiptList" href="cancel-sapar2.jsp" class="btn btn-link"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มรายการการยกเลิก</a></li>
...
function buttonProceedReceiptListClickEvent() {
    ...
    view.dialogAuthentication.show().done(function () {
        ...
        location.href = "cancel-sapar3.jsp";
    });
}
// ---------------------------------------------------------------------
