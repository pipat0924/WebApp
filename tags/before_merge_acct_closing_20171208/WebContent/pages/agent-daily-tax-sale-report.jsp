...
<html>
    <head>
        <title>รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีเต็มรูป (ตัวแทนรับชำระ)</title>
...
//		        $('#stDate').datepicker('setDate', date);
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีเต็มรูป</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีเต็มรูป</div>
                    	<div class="panel-body">
                    		<div class="row">
                    			<div class="col-md-12">
									<form id=documentReportForm method="post" class="form-horizontal" role="form">
										<div class="form-group">
											<label class="control-label col-sm-1 col-sm-offset-1">วันที่รับชำระ:</label>
			            ...
			            <table id="SalesTaxDailyReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="center" data-field="receiptDate" data-sortable="true">วันเดือนปี</th>
				                   <th data-align="center" data-field="receiptNo" data-sortable="true">เลขที่ใบกำกับภาษี</th>
				                   ...
				                   <th data-align="center" data-field="branchNo" data-sortable="true">สาขาที่</th>
				                   <th data-align="right" data-field="charge" data-sortable="true" data-formatter="currencyFormatter">มูลค่าสินค้าหรือบริการ</th>
				                   <th data-align="right" data-field="vat" data-sortable="true" data-formatter="currencyFormatter">จำนวนเงินภาษีมูลค่าเพิ่ม</th>
            ...
            <form action="../printSalesFullTaxDailyReport.pdf" method="post" target="_printForm">
            ...
            <form action="../printSalesFullTaxDailyReport.xls" method="post" target="_printForm">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="endDate" name="endDate"/>
            	<input type="hidden" id="type" name="type" value="FULL"/>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		$("#SalesTaxDailyReport").bootstrapTable("refresh", 
            				{ url: "../getDailySalesTaxReport.json?printPdf=0"
