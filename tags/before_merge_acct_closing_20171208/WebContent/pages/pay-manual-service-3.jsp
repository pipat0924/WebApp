...
<body>
	...
	<section class="container-fluid menu">
		...
		<div class="row">
			<div class="col-md-12">
				<ol id="breadcrumb" class="breadcrumb">
					<li><i>รับชำระค่าบริการหนี้ Manaul</i></li>
		...
		<div id="summaryPanel" style="display: none">
			<ul class="list-inline pull-right list-menu-set">
				<li><a id="submitPayment" class="btn btn-link"><span
						class="glyphicon glyphicon-print"></span> บันทึกและส่งชำระหนี้</a></li>
				<li><a id="" class="btn btn-link"><span
						class="glyphicon glyphicon-remove-circle"></span> ส่งลูกหนี้ Sap</a></li>
				<li><a href="pay-manual-service-1.jsp?new"><span
				...
				<div class="col-md-12">
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<table id="receiptList" data-row-style="rowStyle"
								data-toggle="table"
								...
								<thead>
									<tr>
										...
										<th data-field="customerName" style="size: 50px">ชื่อลูกค้า</th>
										<th data-field="invoice">เลขที่ใบแจ้งค่าใช้บริการ</th>
										<th data-field="issueDt">วันที่จัดทำใบแจ้งค่าใช้บริการ</th>
										<th data-field="dueDt">วันที่ครบกำหนด</th>
										<th data-field="vatTotal">ภาษีมูลค่าเพิ่ม</th>
										<th data-field="chargeTotal">ยอดก่อนภาษี</th>
										<th data-field="totalCharge">ยอดเงินรวมภาษี</th>
										<th data-field="afterSaleDiscount">ส่วนลดหลังการขาย</th>
										<th data-field="wtTotal">ภาษีหัก ณ ที่จ่าย</th>
										<th data-field="balanceDue">จำนวนเงินคงค้าง</th>
		...
		<ul id="navigationPanel" class="list-inline pull-right list-menu-set">
			<li><a href="pay-manual-service-2.jsp" class="btn btn-link"><span
					class="glyphicon glyphicon-th-list"></span> สรุปรายการรับชำระ</a></li>
			<li><a id="summitInsertPayment" class="btn btn-link"><span
					class="glyphicon glyphicon-print"></span> บันทึก</a></li>
	<!-- 		<li><a id="submitPayment" class="btn btn-link"><span
					class="glyphicon glyphicon-print"></span> บันทึกและส่งชำระหนี้</a></li>
			<li><a id="" class="btn btn-link"><span
					class="glyphicon glyphicon-remove-circle"></span> ส่งลูกหนี้ Sap</a></li> -->
			<li><a id="cancelPaymentBtn" class="btn btn-link"><span
		...
		<div id="fillDataInputPanel" class="row">
							...
							<div role="tabpanel" class="tab-pane hide"
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<label class="control-label col-sm-6">เลขที่ใบแจ้งค่าใช้บริการ
											:</label>
										<!-- end ice fixed code no.109 'ทุกระบบต้องเลขที่ใบแจ้งค่าใช้บริการใบแจ้งค่าใช้บริการ" -->
										<div class="col-sm-5">
											<select id="withholdingInvoiceNo" class="form-control"></select>
										</div>
									</div>
									<div class="form-group">
			...
			<div class="col-md-7">
				...
				<div id="setPayType" class="btn-group">
					<button type="button" class="btn btn-default dropdown-toggle"
						data-toggle="dropdown">
						<span class="selection">Manual</span> <span class="caret"></span>
					</button>
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<label class="control-label col-sm-3">อัตราแลกเปลี่ยน
											:</label>
										<div class="col-sm-3">
											<input class="form-control text-right" id="exchangeRateInput"
												value="0.00" readonly>
										</div>
									</div>
									<div class="form-group">
		...
		<div id="fillDataInputPanelManual" class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">ข้อมูลการชำระค่าบริการแบบ Manual</div>
					<div class="panel-body">
						<div class="form-horizontal">
							<div class="form-group row">
								<label class="control-label col-sm-2">เลขที่อ้างอิงใบเสร็จ
									Manual :</label>
								<div class="col-sm-3">
									<input class="form-control" id="inputPayCashRefDoc"
										maxlength="62">
								</div>

								<label class="control-label col-sm-2">วันที่รับชำระ :</label>
								<div class="col-sm-3 input-group input-append date"
									data-date-format="dd/mm/yyyy" id="payDate"
									data-provide="datepicker">
									<input id="paymentDate" class="form-control"
										placeholder="dd/MM/yyyy"> <span
										class="input-group-btn"><a class="btn btn-default"><span
											class="glyphicon glyphicon-calendar"></span></a></span>
								</div>
							</div>
							<div class="form-group">
							
								<label class="control-label col-sm-2">สถานที่รับชำระ
									(BP):</label>
								<div class="col-sm-3 select2Div">
									<select class="form-control" id="inputPayCashBP"
										name="inputPayCashBP"></select>
								</div>
								<label class="control-label col-sm-2">สถานที่รับชำระ
									(BA):</label>
								<div class="col-sm-3 select2Div">
									<select class="form-control" id="inputPayCashBA" 
										name="inputPayCashBA"></select>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-2">จำนวนเงินที่รับชำระ
									:</label>
								<div class="col-sm-3">
									<input id="paymentAmount" class="form-control text-right"
										readonly="">
								</div>
							</div>
						</div>
						...
						<div class="form-horizontal">
							<div class="form-group" id="foreignTotalChargeDiv">
								<label class="control-label col-sm-10"
									id="foreignTotalChargeLabel">ยอดเงินที่ต้องชำระรวมภาษีมูลค่าเพิ่ม
									(Foreign) :</label>
								<div class="col-sm-2">
									<input id="foreignTotalCharge" class="form-control text-right"
										disabled>
								</div>
							</div>
							<div class="form-group" id="foreignExchangeDiv">
								...
								<div class="col-sm-2">
									<input id="foreignExchangeRate" class="form-control text-right"
										disabled>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label col-sm-10">ภาษีหัก ณ ที่จ่าย
									:</label>
								<div class="col-sm-2">
		...
		<div class="modal fade" role="dialog" id="advancePayment">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
								...
								<table id="customerList" data-toggle="table">
									<thead>
										<tr>
											...
											<th data-field="advanceAmount"
												data-formatter="numberInputFormatter">ยอดชำระ</th>
											<th data-field="billCycle"
												data-formatter="billCycleInputFormatter">รอบการใช้งาน</th>
										</tr>
									</thead>
								</table>
							</div>
					...
					<div class="modal-footer">
						<a id="advancePaymentSubmit" class="btn btn-default"><span
							class="glyphicon glyphicon-ok-circle"></span> เลือกรายการ</a> <a
							id="advancePaymentCancel" class="btn btn-default"
								...
								<table id="customerList2" data-toggle="table">
									<thead>
										<tr>
											...
											<th data-formatter="stringInputFormatter"
												data-field="otherNote">เพิ่มเติม</th>
										</tr>
									</thead>
								</table>
							</div>
		...
		<div class="modal fade" role="dialog" id="creditLimitDialog">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<table id="subScriptionListTb" data-maintain-selected="true"
									...
									<thead>
										<tr>
											<!--
												...
												-->
											<th data-formatter="checkboxFormatter"><input
												id="btSelectAll" type="checkbox"></th>
					...
					<div class="modal-footer">
						<a id="creditLimitSubmit" class="btn btn-default"><span
							class="glyphicon glyphicon-ok-circle"></span> เลือกรายการ</a> <a
							id="creditLimitCancel" class="btn btn-default"
							data-dismiss="modal"><span
							class="glyphicon glyphicon-remove-circle"></span> ยกเลิก</a>
					</div>
				</div>
...
var view = (function($){
    ...
    function DropDown(el, url) { 
        ...
        obj.init2 = function(url, v) {if (url) $.get(url, function(res){ if(res!=null){if(res.data[0].rateCode!=null){ exchange = res.data; }} setup2(data = res.data, v);}); else setup2(data, v); return this };
        obj.initV3 = function(url,param) { 
        	$.ajax({
        	    url : url,
        	    type : "get",
        	    data: { "property1": param},
        	    async: false,
        ...
        function setup2(array, v) {
			obj.elem.find("*").remove();
            //$("#currencyTypeSelect").append('<option data-index="0" data-key="0" value="0">กรุณาเลือก</option>');
            obj.elem.append('<option data-index="-1" data-key="-1" value="">กรุณาเลือก</option>');
            $.each(array,function(i,o){
                if(v == 'BP') {
                        obj.elem.append('<option data-index="' + i + '" data-key="' + o.PROPERTY1 + '" value="' + o.PROPERTY1 + '">' + o.PROPERTY1 + '</option>')
                }else{
                        obj.elem.append('<option data-index="'+ i +'" data-key="'+ o.key +'" value="'+ o.key +'"e>'+ o.key +' - '+ o.value +'</option>')
                }
            });
		}	
		this.init(url);
	...
	self.button = new(function(){
		...
		that.summitInsertPayment = new Button("#summitInsertPayment");
	...
	self.panel = new(function(){
		...
		that.fillDataInputPanelManual = new Panel("#fillDataInputPanelManual");
	...
	self.input = new(function(){
		...
		that.paymentAmount = new Input("#paymentAmount");
		...
		that.inputPayCashBP = new DropDown("#inputPayCashBP").init2("../findBussinessPlace.json", "BP");
		that.inputPayCashBA = new DropDown("#inputPayCashBA"); //.init2("../findBussinessArea.json", "BA");
		...
		that.inputPayCashRefDoc = new Input("#inputPayCashRefDoc");
		that.paymentDate = new Input("#paymentDate");
...
$("#inputPayCashBP").select2();
$("#inputPayCashBA").select2();
...
$(document).ready(function () {
	...
	view.input.inputPayCashBA.disable();
...
// 	initialPage();
    ...
    $('#inputPayCashBP').on('change', function () {
    	view.input.inputPayCashBA.enable();
    	view.input.inputPayCashBA.initV3("../findBussinessArea.json",view.input.inputPayCashBP.val());
    	
    });
//     $('#inputPayCashBA').on('change', function () {
...
function setup(){
    ...
    //console.log('xxxx5555');console.log(billingList);console.log('xxxx555');
	view.input.deduct.val(0);
	...
	view.table.payTypeList.onDelete(function(data) {
		if (data.length < 1) {
			...
			view.button.submitPayment.disable();
			view.button.summitInsertPayment.disable();
		}
		calculate();
	});
...
// 			params["checkSpecial"] = checkSpecial;
	...
	$.each(billingList, function(i,o){
		$.each(o.invoiceList, function(j,p){
			...
			deduct += calculateVatWT(p.balanceDue, p.received, p.vatRate, p.deduction, p.totalCharge, p.isStateAgency);
//			p.deduction = 0;
	...
	if(view.containsForeignCurrencyCode && view.allowedCurrenyCode && billingCurrency != null && billingCurrency != "" &&  billingCurrency!="th_TH" ) {
		...
		if(view.session("billingCurrency") != null && (view.session("billingCurrency").indexOf("TH") == -1)){
			view.dialog.mainMessageDialog.warn(["กำลังทำรายการ Invoice สกุลเงินต่างประเทศด้วยอัตราแลกเปลี่ยน "+exchangeRate+" ("+$.trim(window.exchangeRateObj.message)+") ตามอัตราแลกเปลี่ยนวันที่ "+exchangeDate]).show();
		}
...
function addPayTypeClickEvent() {
	...
	if(view.allowedCurrenyCode) {
		...
		view.button.summitInsertPayment.enable();
		view.input.paymentAmount.val(payAmt);
	}
	updateDeduction();
	calculate();
}
function submitPayment(receiptLang) {
	...
	/*if (sumBalanceDue > sumReceived && advance > 0) {
		view.dialog.mainMessageDialog.clear().error(["ระบบไม่อนุญาตให้จ่ายเงินล่วงหน้า เนื่องจากยังค้างชำระเงินกับระบบ"]).show();
		return false;
	}
	if (sumBalanceDue == sumReceived && difBalanceDue > 0 && advance > 0) {
		view.dialog.mainMessageDialog.clear().error(["ระบบไม่อนุญาตให้จ่ายเงินล่วงหน้า เนื่องจากยังค้างชำระเงินกับระบบ"]).show();
		return false;
	}*/
    // allow Advanced 20170407
    /*
	if(hasDueAmount){
		view.dialog.mainMessageDialog.clear().error(["ระบบไม่อนุญาตให้จ่ายเงินล่วงหน้า เนื่องจากยังค้างชำระเงินกับระบบ"]).show();
		return false;
    ...
    */
	...
	var recriptNo = view.input.inputPayCashRefDoc.val();
    ...
    var inputPayCashRefDoc = view.input.inputPayCashRefDoc.val();
    var paymentDate = view.input.paymentDate.val();
    if(inputPayCashRefDoc.length < 1){
    	view.dialog.mainMessageDialog.clear().error(["กรุณากรอกข้อมูลให้ครบ"]).show();
    	document.getElementById("inputPayCashRefDoc").focus();
    	return false;
    }else if(paymentDate.length < 1){
    	view.dialog.mainMessageDialog.clear().error(["กรุณากรอกข้อมูลให้ครบ"]).show();
	...
	while (customer = billingList[custIndex]) {
		...
		params["customers["+ custIndex +"].souceType"] = customer.souceType;
		params["customers["+ custIndex +"].custType"] = customer.custType;
		params["customers["+ custIndex +"].epNameCode"] = view.input.inputPayCashRefDoc.val();
		params["customers["+ custIndex +"].paymentDate"] = view.input.paymentDate.val() + " 00:00:00";
		params["customers["+ custIndex +"].inputPayCashBA"] = view.input.inputPayCashBA.val();
		params["customers["+ custIndex +"].inputPayCashBP"] = view.input.inputPayCashBP.val();
		params["customers["+ custIndex +"].address1"] = customer.address1;
		params["customers["+ custIndex +"].address2"] = customer.address1;
		...
		for (var j = 0, n = customer.invoiceList.length; j < n; j++) {
			...
			params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].withholdingTaxNo"] = view.input.withholdingTaxNo.val();
			...
			params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].billCycle"] = invoice.billCycleSap;
            ...
            params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].taxTypeCode"] = invoice.taxTypeCode;
                ...
                //if(invoice.subNoList != null) {
                	//for (var k = 0 ; k < invoice.subNoList.length ;  k++) {
                       // params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].subNoList["+k+"]"] =  invoice.accountNo[k];
                    //}
               // }
            /* */
            ...
            if(customer.invoiceList.length > 0){
                ...
                $.each(view.table.customerList2.data(), function(i, o){
                    if(customer.custNo == o.custNo){
                        ...
                        var amtExc = amt - vat;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].no"] = invoiceNo;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].amount"] = amtExc;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].discount"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].charge"] = amtExc;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].vat"] = vat;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].vatRate"] = vatR;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].totalCharge"] = amt;

                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].deduction"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].afterSaleDiscount"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].balanceDue"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].received"] = amt;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].change"] = 0;
                       
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].status"] = "OTH";
                        if(deduction > 0) {
                            var watPaymentCase = paymentCase.concat("WT ");
                            $.map((window["wthList"] || []), function(o, i) {
                                console.log('START watPaymentCase : '+watPaymentCase);
    ...
    $.ajax({
     ...
     if(res.data.length > 0){
       ...
       //  $(document.body).append('<form action="../printPaymentReceiptOTBOSS.pdf" method="post" target="_printForm"></form>');
...
//          form.submit();
         ...
         view.panel.fillDataInputPanelManual.hide(1);
         ...
         var receiptList = [], invoice;
         $.each(res.data, function(i,r){
         while (customer = billingList[0].invoiceList[custIndex]) {
        
        	 
        	var total = 0;
    		total = total + customer.received;
         receiptList.push({
         "customerNo": customer.no
         ,"customerName":  billingList[0].custName
         ,"invoice":  customer.no
         ,"issueDt":   customer.issueDate
         ,"dueDt":  customer.dueDate
         ,"vatTotal":  customer.vat.toFixed(2)
         ,"chargeTotal":  customer.charge.toFixed(2)
         ,"totalCharge":  customer.totalCharge.toFixed(2)
         ,"afterSaleDiscount":  customer.discount
         ,"wtTotal":  res.data[0].deduction
         ,"balanceDue":  customer.balanceDue.toFixed(2)
         ,"billCycle":  customer.billCycle
         ,"receiptNo": r.no
         ,"receiptAmount": view.utils.numberFormat(total)
         ,"receiptStatus": '<span class="glyphicon glyphicon-ok-circle"></span> บันทึกลงระบบสำเร็จ'
         ,"invoices": billingList[0].invoiceList.sort(function(a, b){return a.id-b.id})
         });
         ...
         }else{view.dialog.mainMessageDialog.clear().error(["กรุณากรอกเลขที่อ้างอิงใบเสร็จ Manualใหม่ ข้อมูลซ้ำ"]).show()}	
         }
         });
}
...
function summitInsertPayment(receiptLang) {
    var radioChkVal = $("input[name='specialOptions']:checked").val();
	var balanceDue = view.input.balanceDue.val(), received = view.inputReceived.val(), change = view.input.change.val(), advance = view.inputAdvanced.val(), deduction = Math.abs(view.input.deduct.val());
	if (balanceDue > received) {
		view.dialog.mainMessageDialog.clear().error(["ระบบไม่อนุญาตให้จ่าย เนื่องจากจำนวนเงินไม่ถูกต้อง"]).show();
    ...
    */
            ...
            if(customer.invoiceList.length > 0){
                ...
                $.each(view.table.customerList2.data(), function(i, o){
                    if(customer.custNo == o.custNo){
                        ...
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].vatRate"] = vatR;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].totalCharge"] = amt;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].billCycle"] = amt;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].deduction"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].afterSaleDiscount"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].balanceDue"] = 0;
                        params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].received"] = amt;
    ...
    $.ajax({
     ...
     if(res.data.length > 0){
    	var data = {};
    	data.invNo = res.data[0].invoiceNo;
    	data.receiptNo = view.input.inputPayCashRefDoc.val();
    	 view.session("dataManual", data);
    	 window.location.href = 'pay-manual-clearing_1.jsp';
/*      if (!view.dialog.mainMessageDialog.valid(res)) { return; }
...
//      form.submit();
     ...
     ,"totalCharge":  customer.totalCharge.toFixed(2)
     ,"afterSaleDiscount":  customer.discount
     ,"wtTotal":  res.deductionManual[0].amount
     ,"balanceDue":  customer.balanceDue.toFixed(2)
     ,"billCycle":  customer.billCycle
     ,"receiptNo": r.receiptNoManual
     ,"receiptAmount": view.utils.numberFormat(total)
     ,"receiptStatus": '<span class="glyphicon glyphicon-ok-circle"></span> บันทึกลงระบบสำเร็จ'
     ,"invoices": billingList[0].invoiceList.sort(function(a, b){return a.id-b.id})
     });
...
function summitInsertPaymentClickEvent() {
	summitInsertPayment("TH");
}
//return false;
// Credit Limit.
...
function payBankTxnfButtonSubmitGfClickEvent() {
	if(validatePayBankTxnfButtonSubmitGf()) view.payBankTxnfTableListGf.insert(["-", view.payBankTxnfInputBankCodeGf.val(), view.payBankTxnfDropDownBankNameGf.val(), view.payBankTxnfDropDownBankBrnhGf.val(), view.payBankTxnfInputNoGf.val(), view.payBankTxnfInputDateGf.val(), view.payBankTxnfInputAmtGf.val()], true);
}
...
function detailFormatter(val, row, ind) {
	var details = '<table class="table table-striped table-bordered">'
		...
		+ '</thead>' + '<tbody>';
	for (var i = 0, m = row.invoices[i].length; i < m; i++) {
		...
		+ '<td class="text-right">'+ (row.invoices[i].vat == null ? "-" : view.utils.numberFormat(flgExchange? amtVat: row.invoices[i].vat*exchangeRate)) +'</td>'
            + '<td class="text-right">'+ view.utils.numberFormat(row.invoices[i].totalCharge*exchangeRate) +'</td>'
            + '<td class="text-right">'+ view.utils.numberFormat(row.invoices[i].afterSaleDiscount) +'</td>'

		+ '<td class="text-right">'+ view.utils.numberFormat(row.invoices[i].totalCharge*exchangeRate-row.invoices[i].afterSaleDiscount-(row.invoices[i].afterSaleDiscVat == null? 0 : row.invoices[i].afterSaleDiscVat)) +'</td>'
		+ '<td class="text-right">'+ view.utils.numberFormat(row.invoices[i].deduction) +'</td>'
            + '<td class="text-right">'+ view.utils.numberFormat(row.invoices[i].balanceDue*exchangeRate) +'</td>'
...
function  unLockInvoice(){
	...
	$.ajax({
		  ...
		  success:function(data){
			    ...
			    window.location.href="pay-ot-tboss-charge_1.jsp?new"
		  }
		});
}
