    ...
    <body>
		...
		<!--<div class="row" id="panelAdjustDocumentTest"> -->
             <div class="col-md-12 tab-modefile">
               ...
               <!-- Tab panes -->
               <div class="tab-content">
                   <div role="tabpanel" class="tab-pane " id="tab-2-11">
	                               ...
	                               <div class="form-horizontal">
	                                   ...
	                                   <div class="form-group">
	                                       ...
	                                       <div class="col-sm-1">
	                                        ...
	                                        <div class="form-inline">
	                                          	<label >
	                                                  	โปรดระบุ&nbsp;&nbsp;<input class="form-control" value="" size="40" />
	                                           </label>
	                                        </div>
	                                   </div>
	                                   <div class="form-group">
	                                       ...
	                                       <div class="form-inline" >
											    ...
											    Browse <input type="file" name="file" id="myFile">
												</span>
												<span id="fileName" ></span>
												<span id="fileMsg" style="display:inline-block;"></span>
...
/*function Listbox(el, url) { var obj = this, data = []; obj.el = el; obj.elem = $(el);
	...
	self.fileMsg = new Message("#fileMsg");
...
function detailFormatterMain(val, row, ind,templateName) {
 ...
 function BillSelectButtonWithParamEvent(billNo,acctNo) {
  ...
  function btnSubmitClickEvent(res){
