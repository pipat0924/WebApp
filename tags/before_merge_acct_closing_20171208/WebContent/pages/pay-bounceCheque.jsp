                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="col-sm-5">
                                                        ...
                                                        <div class="col-sm-6"><input class="form-control" id="account"></div>
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <label class="control-label col-sm-6">เลขที่ใบแจ้งหนี้ (Doc. Header Text) :</label>
                                                        <div class="col-sm-6"><input class="form-control" id="docHead"></div>
                                                    </div>
                                        ...
                                        <table id="historyList" data-toggle="table" data-classes="table table-hover table-striped" data-pagination="true" data-page-size="5"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="payAmountAR">ยอดเงินตาม<br>ใบแจ้งหนี้</th>
                                                    <th data-field="logPay">วิธีการ<br>ชำระ</th>
                                                    <th data-field="payType">ประเภทการ<br>รับชำระ</th>
                                                    <th data-field="amountCurrency">ยอดชำระเงิน<br>ตามสกุลที่บันทึก</th>
                                                    <th data-field="vat">ภาษีมูลค่าเพิ่ม<br>จากการรับชำระ </th>
                                                    <th data-field="currency">สกุลเงิน</th>
                                                    <th data-field="rateChange">อัตราการแลกเปลี่ยน</th>
                                                    <th data-field="changeDate">วันที่แปลงค่า</th>
                                                    <th data-field="amountCurrencyin">ยอดชำระเงินสกุลในประเทศ</th>
                                                    <th data-field="vatIn">ภาษีมูลค่าเพิ่มจากการรับชำระ</th>
                                                    ...
                                                    <th data-field="message">ข้อความ</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
    ...
    <script type="text/javascript">
        ...
        function advSrcDocHeaderBtnClickEvent() {
            ...
            if (avdDocHead == "") {
                ...
                view.dialog.advanceSearchMessageDialog.showLoad("ระบบกำลังรอข้อมูลจาก Test : {timeCnt} วินาที");
        ...
        function searchBounceCheque() {
            ...
            if (chk) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    success: function (res) {
                        if(res.detailARCustomerDTO!=null){
                        ...
                        // view.dialog.mainMessageDialog.clear();
                        }else view.dialog.mainMessageDialog.clear().error(["ไม่พบข้อมูล"]).show();
