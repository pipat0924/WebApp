...
<html>
<head>
    <title>รายงานภาษีขาย (การยกเลิกใบกำกับภาษีฉบับเดิมและออกฉบับใหม่)</title>
...
<section class="container-fluid menu">
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><i>รายงานภาษีขาย (การยกเลิกใบกำกับภาษีฉบับเดิมและออกฉบับใหม่)</i></li>
            </ol>
            <div class="panel panel-default">
                <div class="panel-heading">รายงานภาษีขาย (การยกเลิกใบกำกับภาษีฉบับเดิมและออกฉบับใหม่)</div>
            ...
            <div class="table-responsive">
                <table id="SalesTaxDailyReport"
                    ...
                    <thead>
                    <tr>
                        <th data-align="center" class="valignMiddle" rowspan="2" data-formatter="runningFormatter">ลำดับที่</th>
                        <th data-align="center" colspan="2" data-sortable="true">ใบกำกับภาษีฉบับใหม่</th>
                        ...
                        <th data-align="center" colspan="2" data-sortable="true">ใบกำกับภาษีฉบับเดิม</th>
                    </tr>
                    <tr>
                        <th data-align="center" data-field="receiptNo" data-sortable="true">เลขที่ใบกำกับภาษี</th>
                        <th data-align="center" data-field="paymentDate" data-sortable="true">วัน เดือน ปี</th>
                        <th data-align="center" data-field="refRecNo" data-sortable="true">เลขที่ใบกำกับภาษี</th>
                        <th data-align="center" data-field="paymentDate" data-sortable="true">วัน เดือน ปี</th>
                    </tr>
                    </thead>
                </table>
    ...
    <form action="../printDailyNewReceiptSaleReport.pdf" method="post" target="_printForm">
    ...
    <form action="../printDailyNewReceiptSaleReport.xls" method="post" target="_printForm">
        <input type="hidden" id="printPdf" name="printPdf" value="1"/>
        <input type="hidden" id="startDate" name="startDate"/>
        <input type="hidden" id="endDate" name="endDate"/>
        <input type="hidden" id="serviceType" name="serviceType" value="CAT"/>
    ...
    <script type="text/javascript">
        $(document).on("click", "a#inquiryReport", function() {
            $("#SalesTaxDailyReport").bootstrapTable("refresh",
                    { url: "../getDailyNewReceiptSaleReport.json?printPdf=0"
