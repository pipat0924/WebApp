							...
							<table id="historyList" data-toggle="table"
								...
								<thead>
									<tr>
										...
										<th data-field="payDate">วันที่ทำ<br>รายการ</th>
										<th data-field="receiptDate">วันที่ออกใบ<br>เสร็จรับเงิน</th>
										...
										<th data-field="arNo">เลขที่<br>ใบแจ้งหนี้</th>
										<th data-field="serviceKey3">บริการ<br>(คีย์อ้างอิง3)</th>
										<th data-field="refDate">รอบการใช้งาน</th>
										<th data-field="payAmountAR" data-formatter="numberFormatterWithCurrency">ยอดเงินตาม<br>ใบแจ้งหนี้</th>
										<th data-field="logPay">วิธีการ<br>ชำระ</th>
										<th data-field="payType">ประเภทการ<br>รับชำระ</th>
										<th data-field="amountCurrency" data-formatter="numberFormatter">ยอดชำระเงิน<br>ตามสกุลที่บันทึก</th>
										<th data-field="vat" data-formatter="numberFormatter">ภาษีมูลค่าเพิ่ม<br>จากการรับชำระ </th>
										<th data-field="currency">สกุลเงิน</th>
										<th data-field="rateChange" data-formatter="numberFormatter">อัตราการแลกเปลี่ยน</th>
										<th data-field="changeDate">วันที่แปลงค่า</th>
										<th data-field="amountCurrencyin" data-formatter="numberFormatterWithCurrencyB">ยอดชำระเงินสกุลในประเทศ</th>
										<th data-field="vatIn" data-formatter="numberFormatter">ภาษีมูลค่าเพิ่มจากการรับชำระ</th>
										<th data-field="docNo">เลขที่เอกสาร</th>
										<th data-field="accountYeah">ปีบัญชี</th>
										<th data-field="status">สถานะ</th>
										<th data-field="remark">หมายเหตุ</th>
										<th data-field="massage">ข้อความ</th>
									</tr>
								</thead>
							</table>
						</div>
        ...
        $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        view.tab.invoiceDetailsTab.index(1);

						view.input.arAccountCode.val(res.data[0].account_no);
						view.input.arName.val(res.data[0].customer_name);
						view.input.glAccount.val(res.data[0].gl_account);
						// view.input.arGroup.val(res.data[0].cus_group);
                        var cusGroup = "2";
