...
<html>
    <head>
        <title>รายงานรับชำระเงิน(ตัวแทนรับชำระ)</title>
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                    	<li><i>รายงานรับชำระเงิน</i></li>
                        <li class="active"><i>รายงานรับชำระเงิน(MNP)</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานรับชำระเงิน(MNP)</div>
                    			...
                    			<form class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-md-2" style="width:3.2%;padding-right: 0px;padding-left: 0px;">
                                         ...
                                         <label class="control-label col-sm-2" style="width:9%">รหัสบัญชี:</label>
                                         <div class="col-sm-2" style="width: 10%;">
											<select class="form-control" id="accountID" name="accountID">
												<option data-index="-1" data-key="-1" value="-1">ทั้งหมด</option>
												<option data-index="0" data-key="1" value="21930040">21930040</option>
												<option data-index="0" data-key="1" value="21930042">21930042</option>
											</select>
										 </div>
                                         <!--< label class="control-label col-sm-2" style="width:8%">Vat Rate:</label> 
                                         <div class="col-sm-2" style="width:10%"  >-->
											<select  style='display:none' class="form-control" id="vatRate" name="vatRate">
			            ...
			            <table id="DailyPaymentReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="center" data-field="payTypeName" data-sortable="true">ประเภทค่าตัวแทน </th>
				                   <th data-align="center" data-field="receiptNo" data-sortable="true">เลขที่ใบเสร็จรับเงิน/ใบกำกับภาษี</th>
				                   <th data-align="center" data-field="accountNo" data-sortable="true">Order ID</th>
				                   <th data-align="left" data-field="receiptName" data-sortable="true">ชื่อผู้ซื้อสินค้า/ผู้รับบริการ</th>
				                   <th data-align="center" data-field="paymentCash" data-sortable="true">ชำระโดย</th>
				                   <th data-align="center" data-field="documentNo" data-sortable="true">เลขที่อ้างอิง</th>
				                   ...
				                   <th data-align="center" data-field="status" data-sortable="true">สถานะ</th>
<!-- 				                   <th data-align="right" data-field="discount" data-sortable="true" data-formatter="currencyFormatter">ส่วนลด</th> -->
					           </tr>
				           </thead>
			          	</table>
			          </div>
            ...
            <form action="../printDailyPaymentReport.pdf" method="post" target="_printForm">
            ...
            <form action="../printDailyPaymentReport.xls" method="post" target="_printForm1">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="endDate" name="endDate"/>
            	<input type="hidden" id="accountID" name="accountID"/>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		$("#DailyPaymentReport").bootstrapTable("refresh", 
            				{ url: "../getDailyPaymentReport.json?printPdf=0"
            						...
            						+"&serviceType=MNP", cache: false });
            			setTimeout(function() { 
            				$("#DailyPaymentReport").bootstrapTable("resetView")
            		}, 200);
            	});
            	$(document).on("click", "a#printReport", function() {
            		$table=$("#DailyPaymentReport");
            		...
            		$.ajax({
            			  type: "POST",
            			  url: "../printDailyPaymentReport.json",
            	...
            	$(document).on("click", "a#printXls", function() {
            		$table=$("#DailyPaymentReport");
            		var data = $table.bootstrapTable("getData");
            		var dataSend = {
            				"sdate":$("#startDate").val().replace(/([0-9]{2}).([0-9]{2}).([0-9]{4})/g,"$1-$2-$3"),
            		...
            		$.ajax({
            			  ...
            			  success:function(data){
            				  ...
            				  $("#tokenXls").val(data);
            				  	...
            				  	document.forms[2].accountID.value = $("#accountID").val();
            				  	document.forms[2].vatRate.value = $("#vatRate").val();
