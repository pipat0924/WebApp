...
<html>
<head>
    <title>รายงานรับชำระเงินสกุลต่างประเทศ</title>
...
//		        $('#stHour').val();
        ...
        function convertCurrencyFormatter(val, row, ind) {
            if(val == null) return "-";
            var str = val.split(" ");
            console.log(str.length);
            if (str.length>1){
                return str[0]+" "+parseFloat(str[1], 10).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
            } else {
                return parseFloat(val, 10).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
            }
        }
...
<section class="container-fluid menu">
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><i>รายงานการรับชำระเงินสกุลต่างประเทศ</i></li>
            </ol>
            <div class="panel panel-default">
                <div class="panel-heading">รายงานการรับชำระเงินสกุลต่างประเทศ</div>
            ...
            <div class="table-responsive">
                <table id="DailyPaymentReport"
                    ...
                    <tr>
                        ...
                        <th data-align="center" data-field="payTypeName" data-sortable="true">ประเภทค่าบริการ </th>
                        ...
                        <th data-align="center" data-field="totalChargeForeign" data-sortable="true" data-formatter="convertCurrencyFormatter">จำนวนเงินรวม (ต่างประเทศ)</th>
                      <%--  pichanan 20170801 --%>
                        <th data-align="center" data-field="currencyRate" data-sortable="true" > Exchange Rate </th>                      
                        ...
                        <th data-align="right" data-field="totalCharge" data-sortable="true" data-formatter="currencyFormatter">จำนวนเงินรวม (บาท)</th>
    ...
    <form id="reprintDailyPaymentReportPdfForm" action="../printDailyPaymentReport.pdf" method="post" target="_printForm">
        ...
        <input type="hidden" id="serviceType" name="serviceType" value="foreign"/>
    </form>
    <form id="reprintDailyPaymentReportXlsForm" action="../printDailyPaymentReport.xls" method="post" target="_printForm1">
        <input type="hidden" id="printPdf" name="printPdf" value="1"/>
        <input type="hidden" id="startDate" name="startDate"/>
        <input type="hidden" id="endDate" name="endDate"/>
        <input type="hidden" id="accountID" name="accountID"/>
