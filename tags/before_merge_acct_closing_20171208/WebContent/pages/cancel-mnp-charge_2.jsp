...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <ul class="list-inline pull-right hide" id="panelNavigation4">
	        <li><a id="addCancelReceiptList" href="cancel-mnp-charge_1.jsp?new" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปยกเลิกรับชำระ</a></li>
	    </ul>
...
function buttonCancelReceiptListClickEvent() {
	...
	console.log(">>>>>>>>>>>>><<<<<<<<<<")
	console.log(val)
	var receiptList = view.tableCancelReceiptList3.rawData();
	var refNo = null, no = null ;
    var params = { "userAuthen": $("#userAuthen").val(),"flgNewReceipt":val.flgNewReceipt, "bankaccountName":val.bankaccountName,"bankaccountNo":val.bankaccountNo,"bankName":val.bankName,"branch":val.branch,"serviceNo":val.serviceNo  };
	...
	$.each(view.tableCancelReceiptList3.rawData(), function(i,o){
		...
		params["receipts["+ i +"].canceldate"] = o.updateDttm;
		params["receipts["+ i +"].accountNo"] = o.accountNo;
        cancelReasonCode = o.cancelReasonCode;
        
	});
	view.buttonCancelReceiptList.showLoad();
	 // post("../cancelPaymentMobile.json", params, function(res){
	  ...
	  $.ajax({
        ...
        ,success: function(res){
            ...
            console.log("XXXXXXXXXXXXXXXXXXXXXX")
            	view.message.clear().error(["javax.xml.ws.WebServiceException: Could not send Message."]).show();
            }else{
            ...
            /* if ("003"==cancelReasonCode) {
                ...
                for (i=0;i < res.data.length; i++) {
                    ...
                    //console.log("id is : "+res.data[i].id)
                    id = res.data[i].id;
                    refRctNo = res.data[i].refRctNo;
                    no = res.data[i].no;
                    ...
                    form.appendChild(input("receipts["+ 0 +"].id", id));
                    form.submit();
                    

                    refNo = refRctNo; no = no; 
...
$(function(){
	var cancelList = view.session("cancelList");
	console.log('55555');console.log(cancelList);console.log('55555');
	view.tableCancelReceiptList3.rawData(cancelList);
});
</script>
</html>
