<%-- 
    Document   : epis-monthly-deduction-report
    Created on : Aug 15, 2017, 1:53:00 PM
...
<html>
    <head>
        <title>รายงานภาษีหัก ณ ที่จ่าย รายเดือน</title>
...
//		        $('#stDate').datepicker('setDate', date);
		    ...
		    function advSrcBillNoBtnClickEvent() {
		        ...
		        if (view.input.year.val().length < 4) {
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">					
                ...
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานภาษีหัก ณ ที่จ่าย รายเดือน</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานภาษีหัก ณ ที่จ่าย รายเดือน</div>
	            	...
	            	<div class="table-responsive">
			            <table id="MonthlyDeductPaymentReport"
			              data-toggle="table"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="center" data-field="receiptDate" data-sortable="true">วันที่</th>
				                   <th data-align="left" data-field="cntReceipt" data-sortable="true">จำนวนฉบับ</th>
				                   <th data-align="right" data-field="amount3tredecim" data-formatter="currencyFormatter" data-sortable="true">ตามมาตรา 3 เตรส</th>
				                   <th data-align="right" data-field="amount69bis" data-formatter="currencyFormatter" data-sortable="true">ตามมาตรา 69 ทวิ</th>
				                   <th data-align="right" data-field="amount69tre" data-formatter="currencyFormatter" data-sortable="true">ตามมาตรา 69 ตรี</th>
				                   <th data-align="left" data-field="remark" data-sortable="true">หมายเหตุ</th>
					           </tr>
				           </thead>
			          	</table>
			          </div>
            ...
            <form action="../printMonthlyDeductPaymentReport.pdf" method="post" target="_printForm">
            ...
            <form action="../printMonthlyDeductPaymentReport.xls" method="post" target="_printForm">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="period" name="period"/>
            	<input type="hidden" id="shop" name="shop"/>
            	<input type="hidden" id="officer" name="officer"/>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		...
            		$("#MonthlyDeductPaymentReport").bootstrapTable("refresh", 
            				{ url: "../getMonthlyDeductPaymentReport.json?printPdf=0"
            						...
            						, cache: false });
            			setTimeout(function() { 
            				$("#MonthlyDeductPaymentReport").bootstrapTable("resetView")
            		}, 200);
