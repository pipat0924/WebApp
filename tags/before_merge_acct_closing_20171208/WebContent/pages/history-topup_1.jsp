...
<html>
    <head>
        ...
        <title>ประวัติการรับชำระค่าบริการ (Top UP)</title>
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb" id="breadcrumb"><li><i>ประวัติการรับชำระค่าบริการ (Top UP)</i></li></ol>
                    <div id="message"></div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="form-horizontal">
                                    <%--<label class="hide" >ประเภทบริการ :</label>
                                    <div class="hide"><select class="hide" id="inputTopupService"></select></div>--%>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" >ประเภทบริการ :</label>
                                        <div class="col-sm-2"><select class="form-control" id="inputTopupService"></select></div>
                                        <label class="control-label col-sm-2">หมายเลขบริการ :</label>
                                        <div class="col-sm-2"><input class="form-control" id="inputSearchServiceNo"></div>
...
function buttonSearchReceiptClickEvent() {
	...
	var params = { "paymentType": "TOPUP" }, service;
	view.message.clear();
    /*if (!view.inputSearchServiceNo.isEmpty()) { service = "svcNo-payType"; params["svcNo"] = view.inputSearchServiceNo.val() }
	...
	get("../service/receipts/search/"+ service, params, function(res){
        ...
        //console.log('55555');console.log(receipts);console.log('55555')
    ...
    params["serviceNo"] = view.inputSearchServiceNo.val();
    params["receiptNo"]    = view.inputSearchReceiptNo.val();
    params["serviceCode"] = view.inputTopupService.val()
    if(params.svcNo == "" && params.no == ""){
        view.message.error(["กรุณากรอกข้อมูล หมายเลขบริการ หรือ หมายเลขใบเสร็จก่อน"]).show(); return;
    }
    else {
        $.get("../findTopupHistory.json", params, function(res){
            view.panelCancelReceiptList1.slideDown(500);
            var receipts = res;
