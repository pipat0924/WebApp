		...
		<form id="payServiceChargeForm" method="post" class="form-horizontal"
			...
			<div class="row">
				<div class="col-md-12 tab-modefile">
					<ol class="breadcrumb">
						<li><i>บริการลูกหนี้นอกสูญ  OTBOSS</i></li>
                        ...
                        if (invoiceReturnedList && invoiceReturnedList.length !== 0) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    location.href = 'pay-ot-tboss-charge_2.jsp';
                                }
                            });
                    });
//                 }
        ...
        view.tab.invoiceDetailsTab.init(2, function () {
            ...
            $.get("../searchottbossdetails.json", { "account": view.input.customerNo.val() , "source" : "OTBOSS" }, function (res) {
