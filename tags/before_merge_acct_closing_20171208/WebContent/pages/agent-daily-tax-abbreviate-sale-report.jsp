...
<html>
    <head>
        <title>รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีแบบย่อ (ตัวแทนรับชำระ)</title>
...
//		        $('#stDate').datepicker('setDate', date);
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีแบบย่อ</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานภาษีขายใบเสร็จรับเงิน/ใบกำกับภาษีแบบย่อ</div>
            ...
            <form action="../printSalesAbbrTaxDailyReport.pdf" method="post" target="_printForm">
            ...
            <form action="../printSalesAbbrTaxDailyReport.xls" method="post" target="_printForm">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="endDate" name="endDate"/>
            	<input type="hidden" id="type" name="type" value="ABVR"/>
