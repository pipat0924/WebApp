<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <head>
        ...
        <title>
            <%=application.getInitParameter("episName")%>
        </title>
    ...
    <%-- <%@include  file="menu.jsp" %> --%>
                <div class="row">
                    <div class="col-md-12 tab-modefile">
                        ...
                        <!-- Nav tabs -->
                        <div class="alert alert-danger" id="messages" role="alert" display:none>
                            <div id="messageData"></div>
                        </div>

                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#tab_cus" aria-controls="tab_cus" role="tab" data-toggle="tab"><span
							class="glyphicon glyphicon-filter" onclick="searchEvent()"></span>
							ค้นหาข้อมูล</a></li>
                        </ul>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2">เลขที่ใบแจ้งค่าบริการ
													:</label>
                                                        <div class="col-sm-2">
                                                            <input class="form-control" id="invoiceCode">
                                                        </div>
                                                        <label class="control-label col-sm-2">เลขที่ใบเสร็จรับเงิน
													:</label>
                                                        <div class="col-sm-2">
                                                            <input class="form-control" id="epCode">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <button type="button" class="btn btn-primary" onclick="searchEvent()">
                ...
                <div class="row">
                <div class="adjustRefund" id="panaldebt" display:none>
                    <!--------------------------------------->
                    <ul id="navigatePanel" class="list-inline pull-right list-menu-set">
                        <li><a id="addAdjustReceiptList" href="adjust-payment_2.jsp" class="btn btn-link"><span
						class="glyphicon glyphicon-plus-sign"></span>
						เพิ่มรายการการขอปรับลดหนี้</a></li>
                        <li><a id="sumAdjustReceiptList" href="adjust-payment_3.jsp" class="btn btn-link"><span class="glyphicon glyphicon-th-list"></span>
						สรุปรายการขอปรับลดหนี้</a><span class="badge badge_modefil">2</span></li>
                    </ul>
                    <!--------------------------------------->
                    <!-- Tab panes -->
                    <div class="col-md-12 tab-modefile">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <span class="glyphicon glyphicon-shopping-cart"></span> รายการขอปรับลดหนี้
                            </h3>
                        </div>
                        <div role="tabpanel" class="tab-pane active" id="tab-2-1">
                            <table id="refundTable" data-row-style="rowStyle" data-toggle="table" data-classes="table table-hover table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="datt" data-align="center">วันที่รับชำระ</th>
                                        <th data-field="accountNo" data-align="center">เลขที่ลูกค้า</th>
                                        <th data-field="name" data-align="center">ชื่อลูกค้า</th>
                                        ...
                                        <th data-field="attributes" data-align="center">สถานะ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <script type="text/javascript">
        var view = (function ($) {
            ...
            self.table = new (function () {
                var that = this;
                that.refundTable = new BootstrapTable("#refundTable");
                function Table(el) {
        ...
        function searchEvent() {
            ...
            if (!epCode && invoiceCode.length < 4) {
                $("#messages").slideDown(400);
                document.getElementById("messageData").innerHTML = "โปรดระบุ 'เลขที่ใบแจ้งค่าบริการ' อย่างน้อย 4 ตัวอักษร";
                $("#messageData").show();
                $(".adjustRefund").hide();
                return false;
            } else if (!invoiceCode && epCode.length < 4) {
                $("#messages").slideDown(400);
                document.getElementById("messageData").innerHTML = "โปรดระบุ 'เลขที่ใบเสร็จรับเงิน' อย่างน้อย 4 ตัวอักษร";
                $("#messageData").show();
                $(".adjustRefund").hide();
                return false;
            }
            ...
            $.ajax({
                type: "GET",
                async: false,
                url: "../refundsearch.json",
                data: dataSouce,
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (res) {
                    if (res.receiptList.length > 0) {
                        view.table.refundTable.rawData($.map((res && res.receiptList ? res.receiptList : []), function (o, i) {
                            console.log(i+" :: Test invoice ::");
                            var invoiceNo = o.invoices[0].no;
                            var payDate = o.payment.date;
                            return {
                                "inv":invoiceNo,
                                "no":o.no,
                                "datt":payDate,
