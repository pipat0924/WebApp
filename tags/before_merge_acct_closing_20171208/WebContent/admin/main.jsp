...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a href="#" style="color: #000;text-decoration: none;font-weight: bold;"><img src="../pages/resources/CATTelecom_Logo.png"/>System Administrator Module. (SAM V.1.0)</a>
		</div>
		<div>
			<ul class="nav navbar-nav">
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" target="page"><span class="glyphicon glyphicon-star"></span> ผังหน่วยงานรับชำระ <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="mg-office.jsp" target="page"><span class="glyphicon glyphicon-road"></span> หน่วยงานรับชำระ</a></li>
						<li><a href="mg-pos_1.jsp" target="page"><span class="glyphicon glyphicon-magnet"></span> เครื่องรับชำระ</a></li>
						<li><a href="mg-officer.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> เจ้าหน้าที่รับชำระ</a></li>
						<li><a href="mg-authen.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> Authen Management</a></li>
						<%--<li><a href="mg-gl.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> GL Management</a></li>--%>
						<li><a href="mg-category-detail.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> Category Management</a></li>
						<li><a href="tax-management.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> จัดการภาษีต่างๆ</a></li>
						<li><a href="source-agent-management.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> จัดการตัวการ</a></li>
						<li><a href="source-address-management.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> จัดการที่อยู่ตัวการ</a></li>
						<li><a href="mg-pay-service.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> จัดการข้อมูลประเภทอื่นๆ</a></li>
												<li><a href="mg-business-place.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> GL Management</a></li>
						<li><a href="mg-agent-address.jsp" target="page"><span class="glyphicon glyphicon-globe"></span> จัดการตัวแทนรับชำระ</a></li>
						
					</ul>
				</li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" target="page"><span class="glyphicon glyphicon-warning-sign"></span> งาน Offline <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="mg-offline_1.jsp" target="page"><span class="glyphicon glyphicon-bullhorn"></span> เครื่องรับชำระ</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" target="page"><span class="glyphicon glyphicon-home"></span> การกำหนดค่าอื่นๆ <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="mg-others_1.jsp" target="page"><span class="glyphicon glyphicon-phone"></span> กลุ่มข้อมูลทั่วไป</a></li>
						<li><a href="mg-master-data.jsp" target="page"><span class="glyphicon glyphicon-phone"></span> Master Data</a></li>
						<li><a href="mg-master-data-byRole.jsp" target="page"><span class="glyphicon glyphicon-phone"></span> Master Data By User Role</a></li>
						<li><a href="epis-master-menu_1.jsp" target="page"><span class="glyphicon glyphicon-phone"></span>จัดการเมนู</a></li>
						<li><a href="epis-master-permission_1.jsp" target="page"><span class="glyphicon glyphicon-phone"></span> จัดการสิทธื์ผู้ใช้</a></li>
						<li><a href="epis-master-princPermission_1.jsp" target="page"><span class="glyphicon glyphicon-phone"></span> Master Data - user</a></li>
					</ul>
				</li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#"><span class="glyphicon glyphicon-user"></span> <span id="userInfo"></span></a></li>
				<li><a href="../pages/logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
			</ul>
		</div>
	</div>
</nav>
...
<div style="position:absolute;top:64px;right:0;bottom:64px;left:0">
	<iframe name="page" style="width:100%;height:100%;border:0" src="admin.jsp"></iframe>
</div>
...
<script>
	...
	var masterDataLookup = '${applicationScope['MASTER_DATA_LOOKUP']}';
	<%-- var masterDataLookup = '<%= application.getAttribute("MASTER_DATA_LOOKUP"); %>';  --%>
	function getMasterDataWithKey(key){
// 	alert('masterDataLookup[key] : '+masterDataLookup["000002"]);
// 	return masterDataLookup[key];
		return '${(applicationScope['MASTER_DATA_LOOKUP'])['000002']}';
	}
