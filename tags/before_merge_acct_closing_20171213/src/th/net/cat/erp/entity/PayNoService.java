...
@Entity
@Table(name="TRSERPAYNOSERVICE")
public class PayNoService {

	@Id
	@SequenceGenerator(name="erp_paynoservice_seq", sequenceName="erp_paynoservice_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="erp_paynoservice_seq")
	@Column(name="PAYNOSERVICEID") private Long id;
