            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานรับชำระเงิน(AGENT)</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">รายงานรับชำระเงิน(AGENT)</div>
                    			...
                    			<form class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-md-2" style="width:3.2%;padding-right: 0px;padding-left: 0px;">
											...
											<select  style='display:none'  id="vatRate" name="vatRate">
			            ...
			            <table id="DailyPaymentReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="center" data-field="agentCode" data-sortable="true">ประเภทตัวแทน</th>
				                   <th data-align="center" data-field="agentName" data-sortable="true">ชื่อตัวแทน</th>
				                   <th data-align="center" data-field="taxId" data-sortable="true">TAX ID</th>
				                   <th data-align="left" data-field="receiptNo" data-sortable="true">เลขที่ใบเสร็จรับเงิน/ใบกำกับภาษี</th>
								   <th data-align="left" data-field="ref1" data-sortable="true">Ref.1</th>
								   <th data-align="left" data-field="ref2" data-sortable="true">Ref.2</th>
            ...
            <script type="text/javascript">
            	...
            	var view = (function($){
            		...
            		var strComboValue = [ 
            			...
            			new DropDown("#soureType").init("../findAllAgentType.json");
            			if(roleName == "Suppervisor" || roleName == "AGENT"){
            				new DropDown("#shop").disable();
            				}
            		return this;
