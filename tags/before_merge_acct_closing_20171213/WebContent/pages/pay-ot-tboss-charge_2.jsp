...
<body>
    ...
    <%-- <%@include  file="menu.jsp" %> --%>
			...
			<div class="col-md-12">
				<ol class="breadcrumb">
				   <li><i>รับชำระ  TBOSS</i></li>
                        ...
                        <li class="active">สรุปรายการรับชำระเงิน</li>
		...
		<ul class="list-inline pull-right list-menu-set">
			<li><a href="pay-ot-tboss-charge_1.jsp?new" class="btn btn-link"><span class="glyphicon glyphicon-user"></span> เพิ่มข้อมูลลูกค้า</a></li>
						...
						<table id="summaryList" data-row-style="rowStyle" data-toggle="table"
							...
							<thead>
								<tr>
									...
									<th data-field="custNames">ชื่อลูกค้า</th>
...
function submitPaymentClickEvent() { location.href = 'pay-ot-tboss-charge_3.jsp'; }
</script>
</html>
