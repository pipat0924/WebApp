...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <div class="row">
	        <div class="col-md-12 tab-modefile">
	        	<ol class="breadcrumb">
                    ...
                    <li class="active">สรุปการอนุมัติปรับลดหนี้</li>
	    ...
	    <ul id="navigatePanel" class="list-inline pull-right list-menu-set">
	        <li><a href="#confirmAdjust" data-toggle="modal"><span class="glyphicon glyphicon-th-list"></span> ดำเนินการอนุมัติขอปรับลดหนี้</a></li>
					...
					<table id="table_1"
                       ...
                       <thead>
                           <tr>
                            ...
                            <th data-field="adjustAmt" data-align="center">เงินอนุมัติ</th>
                            <th data-field="branch" data-align="center">สถานที่รับชำระ</th>
		                    <th data-field="username" data-align="center">ผู้ขอปรับลด</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a id="appAdjustReceiptList" href="approve-adjust-payment_4.jsp" class="btn btn-success"><span class="glyphicon glyphicon-ok-circle"></span> ตกลง</a>
