    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <ul class="list-inline pull-right">
                ...
                <li><a href="pay-3-stap_2.jsp"><span class="glyphicon glyphicon-th-list"></span> สรุปรายการเงินโอน</a></li>
            </ul>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">ข้อมูลการโอนเงิน</h3>
                </div>
                <div class="panel-body">
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" >เลขที่ลูกค้า :</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" value="66665278">
                                    </div>
                                    <label class="control-label col-sm-2" ></label>
                                    <div class="col-sm-1"> </div>
                                    <label class="control-label col-sm-3">รหัสบัญชีเงินฝากธนาคาร :</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" ></label>
                                    <div class="col-sm-1"> </div>
                                    <label class="control-label col-sm-3">หมายเลขบัญชีเงินฝากธนาคาร :</label>
                                    <div class="col-sm-2">
                                        <select class="form-control">
                                            <option>1</option>
                                            <option>2</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" ></label>
                                    <div class="col-sm-1"> </div>
                                    <label class="control-label col-sm-3">ค่าธรรมเนียม :</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" ></label>
                                    <div class="col-sm-1"> </div>
                                    <label class="control-label col-sm-3">ลูกหนี้ :</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" ></label>
                                    <div class="col-sm-1"> </div>
                                    <label class="control-label col-sm-3">SAP DOC :</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2" >Currency Code :</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" value="">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-2">บัญชีพักหนี้ :</label>
                                    <div class="col-sm-2">
                                        <input class="form-control" value="">
                                    </div>
                                </div>
