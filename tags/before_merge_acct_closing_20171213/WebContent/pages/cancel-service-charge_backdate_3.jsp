...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <ul class="list-inline pull-right hide" id="panelNavigation4">
	        <li><a id="addCancelReceiptList" href="cancel-service-charge_1.jsp?new" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปยกเลิกรับชำระค่าบริการ</a></li>
	    </ul>
...
$(function(){
	view.tableCancelReceiptList3.clear();
...
function buttonCancelReceiptListClickEvent() {
	...
	var receiptList = view.tableCancelReceiptList3.rawData();var refNo = null, no = null , receiptNo = null, isCall = true;
