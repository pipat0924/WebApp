...
public class ThaiBahtUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Negative value of -1257.5463 : " + new ThaiBahtUtil().getText(-1257.5463));
        System.out.println("Positive value of 1231.5463 : " + new ThaiBahtUtil().getText(1231.5463));
        System.out.println("Negative string value of -1,234.5463 : " + new ThaiBahtUtil().getText("-1,234.5463"));
        System.out.println("Positive string value of 1,234.5463 : " + new ThaiBahtUtil().getText("1,234.5463"));
    }
}
