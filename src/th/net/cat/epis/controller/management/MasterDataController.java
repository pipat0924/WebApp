...
//   	}
    ...
    @RequestMapping(value = "findByGroupKeyAndRoleOutDay.json", method = RequestMethod.GET)
  	public void findByGroupKeyAndRoleOutDay(@RequestParam("groupKey") String groupKey, ModelMap modelMap) {
    	Set<String> key = new HashSet<String>();
    	key.add("OUTDAY");
    	key.add("ALLDAY");
    	String role = EpContextHolder.getContext().getRoleName();
  		modelMap.addAttribute("data", masterDataRepository.findByGroupKeyAndPropertyTwoThree(groupKey,key,role));
  		modelMap.addAttribute("statusCode", "0");
  	}
    @RequestMapping(value = "findByGroupKeyAndRoleInDay.json", method = RequestMethod.GET)
  	public void findByGroupKeyAndRoleInDay(@RequestParam("groupKey") String groupKey, ModelMap modelMap) {
    	Set<String> key = new HashSet<String>();
//    	key.add("OUTDAY");
    	key.add("ALLDAY");
    	String role  = EpContextHolder.getContext().getRoleName();
