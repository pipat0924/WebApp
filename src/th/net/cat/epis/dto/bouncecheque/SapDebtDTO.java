...
public class SapDebtDTO{
	...
	private String localAmountAr;                                               
	private String transAmountAr;                                              
	private Date docDateAr;
	private String postingDateAr;
	private Date exchRateDateAr;
	private String docHeaderTextInv;                                          
	private String refSapPeriod;                                               
	private String awText;
	private String costCenterSap;                                            
	private String segmentCode;                                               
	private String ref1SapRegionCode;                                        
	private String ref2ProductCode;                                           
	...
	private String customerHomeStreet;                                         
	private String customerPostcode;                                            
	private String customerCity;                                                
	private String customerCountryKey;                                         
	private String customerTaxId;                                              
	private String customerBranchCode;                                         
	private Double localBalanceDue;                                                
	private Double transBalanceDue;                                                
	private Double localTotalPaid;                                                 
	private Double localVatPaid;                                                   
	private Double transTotalPaid;                                                 
	private Double transVatPaid;                                                  
	private String exchRateDatePaid;
	private String exchRatePaid;                                                   
	...
	public String getLocalAmountAr() {
		return localAmountAr;
	}
	public void setLocalAmountAr(String localAmountAr) {
		this.localAmountAr = localAmountAr;
	}
	public String getTransAmountAr() {
		return transAmountAr;
	}
	public void setTransAmountAr(String transAmountAr) {
		this.transAmountAr = transAmountAr;
	}
	public Date getDocDateAr() {
		return docDateAr;
	}
	public void setDocDateAr(Date docDateAr) {
		this.docDateAr = docDateAr;
	}
	public String getPostingDateAr() {
		return postingDateAr;
	}
	public void setPostingDateAr(String postingDateAr) {
		this.postingDateAr = postingDateAr;
	}
	public Date getExchRateDateAr() {
		return exchRateDateAr;
	}
	public void setExchRateDateAr(Date exchRateDateAr) {
	...
	public Double getLocalBalanceDue() {
		return localBalanceDue;
	}
	public void setLocalBalanceDue(Double localBalanceDue) {
	...
	public Double getLocalTotalPaid() {
		return localTotalPaid;
	}
	public void setLocalTotalPaid(Double localTotalPaid) {
		this.localTotalPaid = localTotalPaid;
	}
	public Double getLocalVatPaid() {
		return localVatPaid;
	}
	public void setLocalVatPaid(Double localVatPaid) {
		this.localVatPaid = localVatPaid;
	}
	public Double getTransTotalPaid() {
		return transTotalPaid;
	}
	public void setTransTotalPaid(Double transTotalPaid) {
		this.transTotalPaid = transTotalPaid;
	}
	public Double getTransVatPaid() {
		return transVatPaid;
	}
	public void setTransVatPaid(Double transVatPaid) {
