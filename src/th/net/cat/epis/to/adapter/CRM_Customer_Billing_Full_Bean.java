...
public class CRM_Customer_Billing_Full_Bean {
	...
	public CRM_Customer_Billing_Full_Bean(String cat_bill_acct_number,
			String tax_register_number, String bill_first_name,
			String bill_last_name, String bill_comp_name, String branch_id,
			String customer_type, String billing_group, String bill_addr_line1,
			String bill_addr_line2, String bill_addr_line3,
			String bill_addr_line4, String bill_addr_khet_amphur,
			String bill_addr_province_lkp, String bill_addr_post_code, String vat_addr_line1,
			String vat_addr_line2, String vat_addr_line3,
			String vat_addr_line4, String vat_addr_khet_amphur,
			String vat_addr_province_lkp, String vat_addr_post_code) {
	...
	public String getBill_addr_line2() {
		return bill_addr_line2 == null? "":bill_addr_line2;
	}
	...
	public String getBill_addr_line3() {
		return bill_addr_line3 == null? "":bill_addr_line3;
	}
