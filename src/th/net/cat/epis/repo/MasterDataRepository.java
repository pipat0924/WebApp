...
public interface MasterDataRepository extends CrudRepository<MasterData, Long>{
	...
	@Query(value="select masterdata0_.* from MASTER_DATA masterdata0_ WHERE masterdata0_.GROUP_KEY = :groupKey and PROPERTY_2 IN :property2List and  PROPERTY_3 like %:property3% ORDER BY masterdata0_.ORDERED ASC", nativeQuery=true)
	List<MasterData> findByGroupKeyAndPropertyTwoThree(@Param("groupKey") String groupKey,@Param("property2List") Set<String> property2List,@Param("property3") String property3);
