    ...
    <body>
        ...
        <section class="container-fluid menu">
			...
			<ul class="list-inline pull-right list-menu-set">
				<li><a href="pay-tboss-charge_1.jsp?new"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> กลับไปหน้าการรับชำระ</a></li>
			</ul>
			<div class="row">
				<div class="col-md-12">
...
function  unLockInvoice(){
	...
	$.ajax({
		  ...
		  success:function(data){
			    ...
			    window.location.href="pay-tboss-charge_1.jsp?new"
		  }
		});
}
