...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <div class="row">
	        <div class="col-md-12 tab-modefile">
               	<ol class="breadcrumb">
                    ...
                    <li>ค้นหาข้อมูลคำร้องขอปรับลดหนี้</li>
                    <li class="active">รายละเอียดขอปรับลดหนี้</li>
	    ...
	    <ul id="navigatePanel" class="list-inline pull-right list-menu-set">
	        ...
	        <li><a href="#confirmAppAdjust" data-toggle="modal"><span class="glyphicon glyphicon-plus-sign"></span> เลือกรายการขอปรับลดหนี้</a></li>
						...
						<table id="table_1"
	                       ...
	                       <thead>
	                           <tr>
									...
									<th data-field="adjustApp" data-align="center">เงินอนุมัติ</th>
								</tr>
	                       </thead>
	                       <tbody>
	                           <tr>
                               ...
                               <div class="form-horizontal">
                                   <div class="form-group">
                                       ...
                                       <div class="col-sm-6">
                                           <div class="checkbox">
                                               <label>
                                                   &nbsp;<input type="checkbox" checked="true"> คำร้องขอปรับลดหนี้ของผู้ใช้บริการหรือบันทึกขอปรับลดหนี้ของหน่วยงานต้นเรื่อง
                                               </label>
                                           </div>
                                       </div>
                                   </div>
...
-->                                        
           ...
           <div class="modal fade" role="dialog" id="confirmAppAdjust">
			<div class="modal-dialog">
                <div class="modal-content">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-sm-4" style="text-align: left">
                                            <input type="radio" name="RadioOptions1" id="RadioOptions1" value="" checked=""> อนุมัติการขอปรับลดหนี้
                                        </label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-sm-11" style="text-align: left">
                                            <input type="radio" name="RadioOptions1" id="RadioOptions2" value=""> ไม่อนุมัติการขอปรับลดหนี้
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-1" ></label>
					...
					<a id="appAdjustReceiptList" href="approve-adjust-payment_3.jsp" class="btn btn-success"><span class="glyphicon glyphicon-ok-circle"></span> ตกลง</a>
...
function detailFormatter(val, row, ind) {
	return    	'<table class="table table-striped table-bordered">'+
			    	...
			    	'<tbody>'+
			    		...
			    		'<tr><td class="text-center">102010500</td><td class="text-center">INMARSAT2</td><td class="text-center">4</td><td class="text-center">INMARSAT-2</td><td class="text-center">02</td><td class="text-center">200.00</td><td class="text-center">0.00</td><td class="text-center"><input class="text-right" value="0.00" style="width:85px"></td></tr>'+
			    	'</tbody>'+
		    	'</table>';	
}
</script>
