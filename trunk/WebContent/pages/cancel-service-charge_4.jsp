...
<body>
	...
	<section class="container-fluid menu">
	    ...
	    <ul id="navigatePanel" class="list-inline pull-right list-menu-set">
	        <li><a id="addCancelReceiptList" href="cancel-service-charge_1.jsp" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปยกเลิกรับชำระค่าบริการ</a></li>
	    </ul>
	    <!--------------------------------------->
		<div class="row">
			<div class="col-md-12 tab-modefile">
					...
					<table id="table_1"
                       ...
                       <tbody>
                           <tr>
                               ...
                               <td>ศบล.แจ้งวัฒนะ</td>
	                           <td>EPIS2016</td>
                               <td><span class="glyphicon glyphicon-ok-circle"></span> ยกเลิกสำเร็จ</td>
                        	</tr>
                       </tbody>
                   </table>
			</div>
