...
<html>
    <head>
        <title>รายงานภาษีหัก ณ ที่จ่าย (ตัวแทนรับชำระ)</title>
...
//		        $('#stDate').datepicker('setDate', date);
    ...
    <body>
        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-2" style="width:3.2%;padding-right: 0px;padding-left: 0px;">
											<select class="form-control" id="stMin" name="stMin" style="padding:0;">
												...
												<option data-index="2" data-key="59" value="59">59</option>
											</select>
										</div>
										<label class="control-label col-sm-2" style="width: 13%;">ถึงวันที่:</label>
                                         <div class="col-sm-2" style="width:13%">
                                      ...
                                      <div class="form-group">
										...
										<label class="control-label col-sm-3" style="width:11.3%">เจ้าหน้าที่:</label>
										<div class="col-sm-3" style="width:22%">
	            	...
	            	<div class="table-responsive">
			            <table id="DailyDeductPaymentReport"
			              data-toggle="table"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="center" data-field="deductionNo" data-sortable="true">เล่มที่/เลขที่</th>
            ...
            <form action="../printDailyDeductPaymentReport.pdf" method="post" target="_printForm">
            ...
            <form action="../printDailyDeductPaymentReport.xls" method="post" target="_printForm">
            	<input type="hidden" id="printPdf" name="printPdf" value="1"/>
            	<input type="hidden" id="startDate" name="startDate"/>
            	<input type="hidden" id="endDate" name="endDate"/>
            	<input type="hidden" id="shop" name="shop"/>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		$("#DailyDeductPaymentReport").bootstrapTable("refresh", 
            				{ url: "../getDailyDeductPaymentReport.json?printPdf=0"
...
//             						+"&period="+$("#period option:selected").val()
            						...
            						, cache: false });
            			setTimeout(function() { 
            				$("#DailyDeductPaymentReport").bootstrapTable("resetView")
            		}, 200);
