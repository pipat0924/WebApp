    ...
    <%-- <%@include  file="menu.jsp" %> --%>
		<div class="row">
			<div class="col-md-12 tab-modefile">
				<ol class="breadcrumb">
					...
					<li class="active">ค้นหารับชำระตัวแทน</li>
					<li>ระบุเหตุผลรับชำระตัวแทน</li>
					<li>สรุปการยกเลิกรับชำระตัวแทน</li>
		...
		<ul class="list-inline pull-right hide" id="panelNavigation1">
			...
			<li><a id="sumCancelReceiptList"
				href="cancel-agent-charge_2.jsp" class="btn btn-link"><span
					...
					<table data-toggle="table" id="tableCancelReceiptList1" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
						<thead>
							<tr>
								...
								<th data-field="services" data-align="center"
									data-formatter="serviceTypesFormatter">ชื่อบริการ</th>
		...
		<ul id="panelNavigation2" class="list-inline pull-right hide">
			<li><a id="buttonSearchReceiptList"
				href="cancel-agent-charge_1.jsp" class="btn btn-link"><span
					class="glyphicon glyphicon-arrow-left"></span> ยกเลิกรายการ</a></li>
...
function buttonSearchClickEvent() {
	var url = "", params = {};
	view.message.clear();
	     if ( !view.inputSearchReceiptNo.isEmpty()) {url = "../invPayTypeAGENT.json";    params= { "receiptNo" : view.inputSearchReceiptNo.val(),  "payType": "AGENT" } }
...
function buttonProceedReceiptListClickEvent() {
	...
	view.dialogAuthentication.show().done(function(){
		...
		location.href = "cancel-agent-charge_2.jsp";
	});
}
$(function(){
