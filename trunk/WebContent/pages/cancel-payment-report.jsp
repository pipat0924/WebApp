...
<html>
    <head>
        <title>รายงานการยกเลิกการรับชำระเงิน</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i>รายงานการยกเลิกการรับชำระเงิน</i></li>
                    </ol>
                    <div class="panel panel-default">
                    	<div class="panel-heading">ข้อมูลการยกเลิกการรับชำระเงิน</div>
			            ...
			            <table id="CancelPaymentReport"
				          ...
				          <thead>
					          <tr>
				                   ...
				                   <th data-align="left" data-field="accountNo" data-sortable="true">เลขที่สัญญา </th>
				                   <th data-align="left" data-field="receiptName" data-sortable="true">ชื่อ-นามสกุล</th>
				                   <th data-align="left" data-field="collectionUnit" data-sortable="true">หน่วยงานติดตามหนี้</th>
				                   <th data-align="center" data-field="invoiceNo" data-sortable="true">เลขที่A/R อ้างอิง</th>
				                   <th data-align="center" data-field="receiptNo" data-sortable="true">เลขที่ใบเสร็จรับเงิน/ใบกำกับภาษี</th>
				                   <th data-align="left" data-field="paymentCash" data-sortable="true">การชำระเงิน</th>
            ...
            <script type="text/javascript">
            	$(document).on("click", "a#inquiryReport", function() {
            		$("#CancelPaymentReport").bootstrapTable("refresh", 
            				{ url: "../getListCancelPaymentReport.json?printPdf=0"
