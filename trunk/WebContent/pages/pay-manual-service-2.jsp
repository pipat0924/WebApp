...
<body>
    ...
    <%-- <%@include  file="menu.jsp" %> --%>
		...
		<ul class="list-inline pull-right list-menu-set">
			<li><a href="pay-manual-service-1.jsp?new" class="btn btn-link"><span class="glyphicon glyphicon-user"></span> เพิ่มข้อมูลลูกค้า</a></li>
...
function submitPaymentClickEvent() { location.href = 'pay-manual-service-3.jsp'; }
</script>
</html>
