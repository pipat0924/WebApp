...
<section class="container-fluid menu">
    ...
    <input type="hidden" name="wtRental" id="wtRental" value="">
    <input type="hidden" name="wtUsage" id="wtUsage" value="">
    <input type="hidden" name="wtAvg" id="wtAvg" value="">
        <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" id=""><input type="hidden" id="acctCatLkp"><input type="hidden" id="catCustomerSegment">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2 col-sm-offset-8">VAT Rate :</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 tab-modefile">
                                        <ul id="addressTab" class="nav nav-tabs" role="tablist">
                                            ...
                                            <li role="presentation" class="">
                                                <div class="checkbox" style="margin-left: 20px"><label> &nbsp;<input id="receiptInvoiceDocumentOnly" type="checkbox" value="true">ใบกำกับภาษีอย่างเดียว</label></div>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
            ...
            <div class="col-md-12 tab-modefile">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tab-2-1">
                        <table id="invoiceList" name="tableinvoiceheader" data-maintain-selected="true" class="table table-hover" data-toggle="table" data-detail-view="true" data-detail-formatter="invoiceServiceFormatter" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
                            <thead>
                            <tr>
                                ...
                                <th data-field="totalCharge" data-sortable="true" data-align="right" data-formatter="numberFormatter">จำนวนเงิน<br>รวมภาษี</th>
                                <th data-field="totalAdj" data-sortable="true" data-align="right" data-formatter="numberFormatter">ยอดเงิน<br>ปรับลด</th>
                                <th data-field="balanceDue" data-sortable="true" data-align="right" data-formatter="numberFormatter">จำนวนเงิน<br>คงค้าง</th>
                                <th data-field="totalPaid" data-sortable="true" data-align="right" data-formatter="moneyInputFormatter">ยอดชำระ</th>
                                ...
                                <th data-field="aging" data-align="center" data-sortable="true" data-formatter="numberAgingFormatter">ระยะเวลาคงค้าง<br>(วัน)</th>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-2-2">
                        <table id="historyList" data-toggle="table" data-classes="table table-hover table-striped" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
                            <thead>
                            <tr>
                                ...
                                <th data-field="totalCharge" data-align="right" data-formatter="numberFormatterWithCurrency">ยอดเงินตามใบแจ้ง<br>ค่าบริการ</th>
                                <%--<th data-field="afterSaleDiscount" data-align="right" data-formatter="numberFormatter">ส่วนลด<br>หลังการขาย</th>--%>
                                ...
                                <th data-field="vatAmt" data-align="right" data-formatter="numberFormatter2">ภาษีมูลค่าเพิ่ม<br>จากการรับชำระ</th>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab-2-3">
                        <table id="changeList" data-row-style="rowStyle" data-toggle="table" data-classes="table table-hover table-striped"
                            ...
                            <tr>
                                ...
                                <!-- 										<th data-field="payType" data-formatter="payTypeFormatter">ประเภทการชำระ</th> -->
                                <!-- 										<th data-field="trackingId">Tracking ID</th> -->
                                <!-- 										<th data-field="trackingIdServ">Tracking ID Serv</th> -->
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-6">ยอดเงินก่อนหักส่วนลด :</label>
                                <div class="col-sm-2"><input id="beforeDiscountAmount" class="form-control text-right" disabled></div>
                            </div>

                            <div class="form-group">
                                <%--<label class="control-label col-sm-2" >
                                    <!--
                                    <input type="checkbox" id="advancedCheckbox" name="advancedCheckbox" disabled>
                                    -->
                                    <input type="checkbox" id="advancedCheckbox" name="advancedCheckbox" >
                                    &nbsp;&nbsp;&nbsp;รับชำระเงินล่วงหน้า</label>
                                <div class="col-sm-2"><input id="advancedAmount" class="form-control"></div>--%>
                                ...
                                <label class="control-label col-sm-6">ส่วนลด :</label>
                                <div class="col-sm-2"><input id="discountAmount" class="form-control text-right" disabled></div>
                            </div>
                            <div class="form-group">
                                <%--<label class="control-label col-sm-2" >รอบการใช้งาน</label>
                                <div class="col-sm-2"><input id="billCycle" class="form-control" maxlength="140"></div>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">--%></div>
                                <div class="col-sm-2">
                                    <input id="inputAdditionalDiscount" class="form-control text-right" disabled></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                                    ...
                                    <div class="form-inline col-md-12">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group col-md-8">
                                                <input type="text" class="form-control" id="advSrcBillNo" placeholder="กรุณาป้อนข้อมูลที่ต้องการค้นหาอย่างน้อย 6 ตัวอักษร">
                ...
                <i class="pull-left"><span class="glyphicon glyphicon-filter"></span>
                    กรุณาป้อนข้อมูลที่ต้องการค้นหาอย่างน้อย 6 ตัวอักษร
                </i>
                <br>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var view = (function($){
        ...
        function CheckBox(el) { var obj = this; obj.el = el; obj.elem = $(el); obj.elem.click(window[obj.elem.attr("name") +"ClickEvent"])
            ...
            obj.checked = function(){ obj.elem.each(function(i,o){ o.checked = true }); return this }
        }
        ...
        self.input = new(function(){
            ...
            that.wtRental = new Input("#wtRental");
            that.wtUsage = new Input("#wtUsage");
            that.wtAvg = new Input("#wtAvg");
...
//                 }
    ...
    function buildBillingList() {
        ...
        /* end ADD e-GP */
        /* start add by kao */
        bill.wtUsage = view.input.wtUsage.val();
        bill.wtRental = view.input.wtRental.val();
        bill.wtAvg = view.input.wtAvg.val();
        /* end add by kao */
        ...
        for(var rowid=0;rowid<data.length;rowid++){
            ...
            if (checked) {
                ...
                //start add by kao 25600920 1409
                invoice.wtUsage = view.input.wtUsage.val();
                invoice.wtRental = view.input.wtRental.val();
                invoice.wtAvg = view.input.wtAvg.val();
                //end add by kao 25600920 1409
                //var receivedList = document.getElementsByName("received");
                //var receivedValue =receivedList[rowid].value;
                ...
                if(invoice.deduction > 0){
                	...
                	if(invoice.totalCharge != invoice.received){ invoice.deduction = invoice.balanceDue * view.input.wtAvg.val();}
        ...
        if (isPrepaid) {
            ...
            if( view.custInfoInputCurrencyCode.val() == 'en_EUR'){
            	invoice.currencyCode = 03;
            }else if( view.custInfoInputCurrencyCode.val() == 'en_US'){
               invoice.currencyCode = 1;
            }else{
    ...
    function searchClickEvent() {
        ...
        get("../service/bill-profiles/search/no", { "no": (window.billNoSelected = billNo) }, function(res) {
            var profile = res;
            chkDeduct = profile.catCustomerSegment;
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data>0){
                        ...
                        view.session("billingGroupCode",$.trim(profile.billGroup));
                      ...
                      //  view.inputCustomerSegment.key(profile.accountCategoryLookup);
                        ...
                        $('#inputCustomerSegment option[data-key='+profile.accountCategoryLookup+']').attr('selected','selected');
                        $('#inputCustomerSegment').val(profile.accountCategoryLookup)

                        view.advancedCheckbox.unchecked();
                        view.advancedAmount.disable();
                        view.billCycle.disable();
...
// 			}
                        ...
                        view.acctCatLkp.val(profile.accountCategoryLookup);
                        view.catCustomerSegment.val(profile.catCustomerSegment);
                      ...
                      //start get var list
                        var dataVat = { "key" : view.inputCustomerSegment.key()};
                          $.ajax({
	                           type: "POST",
	                           url: "../MasterData/findByGroupKeyList.json",
	                           data: JSON.stringify(dataVat),
	                           dataType: "json",
	                            async: false,
	                           contentType: "application/json; charset=utf-8",
	                           success:function(res){
                               ...
                               if(res.statusCode == 1){
                                    var wt = res.data;
                                        view.input.wtUsage.val( parseFloat(wt[0]/100));
                                        view.input.wtRental.val( parseFloat(wt[1]/100));
                                        view.input.wtAvg.val( parseFloat(wt[2]/100));
                               }
                            },
                            error: function() {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            success:function(res){
                                //console.log('dddddddd');console.log(res);console.log('dddddddd');
                                var invoiceData = [];
                                if(res.data.length>0){
                                    invoiceData = $.map(res.data, invoiceListMapper);
                                    invDisplay = res.data[0].invoiceDisplay;
                                }
                                console.log(invoiceData);
                            	

                                if(invoiceData.length > 0) view.table.invoiceList.rawData(invoiceData);
                                console.log('invoiceData and invoiceList');console.log(invoiceData);console.log(view.table.invoiceList.data());console.log('invoiceData and invoiceList');
                               // view.advancedCheckbox.disable(invoiceData.length > 0);
                                ...
                                $.ajax({
                                    ...
                                    success:function(res){
                                        ...
                                        if(isBarcode || view.advanceInvSelected != null){
                                            var defaultInv = isBarcode ? barCodeArr[2].substr(0, barCodeArr[2].length-8) : view.advanceInvSelected;
...
// 	view.table.invoiceList.hideLoad();
        ...
        $.get("../findPaymentDetails.json", { "billingNo": billNoSelected }, function(res) {
            ...
            view.table.changeList.hideLoad().rawData($.map((res && res.data ? res.data : []), function(o,i){
                ...
                return {
                    ...
                    ,"processedDt": view.utils.dateFormat(o.processDate)
    ...
    $(document).ready(function() {
        ...
        var isAddInvoice =  view.utils.queryString()["addInvoice"]
        ...
        if(!isNew && !isManual && !isAddInvoice){ view.session("billingList", []);}
        var billingList = view.session("billingList");
    	...
    	if(cancelList){
	    	 if(cancelList.length>0){
	    		 view.input.billNo.val(cancelList[0].accountNo);
	    		 searchClickEvent();
	    		 view.inputAdditionalRemark.val("เป็นการยกเลิกและออกใบกำกับภาษีฉบับใหม่แทนฉบับเดิม เลขที่ " +cancelList[0].no);
	    		 view.inputAdditionalRemark.disable();
	    	}
    	}
    ...
    function invoiceListMapper(o) {
        ...
        if(cancelList && cancelList.length> 0){
        	if (o.billNo == cancelList[0].invoices[0].no){
        		
 				if(o.balanceDue >= cancelList[0].totalCharge){
 					totalPaid = cancelList[0].totalCharge
 				}else{
 					totalPaid = o.balanceDue;
 					view.advancedCheckbox.checked();
 					var inputadv =  cancelList[0].totalCharge - o.balanceDue;
 					view.advancedAmount.val(inputadv);    
 				}
        ...
        return {
            ...
            ,"totalPaid": stripToNumberWithFormat(totalPaid)
            ...
            ,"deduct": chkDeduct == 3?0.00:(o.rentalCharge *  view.input.wtRental.val() ) + (o.usageCharge * view.input.wtUsage.val())
    ...
    function writeOffInvoiceListMapper(o) {
        ...
        return {
            ...
            ,"balanceDue": stripToNumberWithFormat(o.balanceDue)
            ,"totalAdj": stripToNumberWithFormat(o.totalAdj)
            ,"totalPaid": stripToNumberWithFormat(o.balanceDue)
            ,"rentalCharge": o.rentalCharge
            ,"usageCharge": o.usageCharge
            //,"deduct": (o.rentalCharge * (isStateAgency ? 0.01 : 0.05)) + (o.usageCharge * (isStateAgency ? 0.01 : 0.03))
            ,"deduct": (o.rentalCharge *  view.input.wtRental.val() ) + (o.usageCharge * view.input.wtUsage.val())
            ,"billCycle": view.utils.dateFormat(o.chargeCycleFromDate) +" - "+ view.utils.dateFormat(o.chargeCycleToDate)
            ,"billRefNo": o.billNo
            ,"currencyCode": o.currencycode
            ,"status": "หนี้สูญ"
    ...
    function calculate() {
        ...
        view.input.deduct.val( sumDeduct > 0 ? (balance * view.input.wtAvg.val() ).toFixed(2) : 0  );
