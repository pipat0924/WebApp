    ...
    <%-- <%@include  file="menu.jsp" %> --%>
		<form id="payServiceChargeForm" method="post" class="form-horizontal" role="form">
			...
			<ul id="navigatePanel" class="hide list-inline pull-right list-menu-set">
				...
				<li><a id="summaryPayment" class="btn btn-link"><span class="glyphicon glyphicon-th-list"></span> สรุปรายการรับชำระ</a><span class="badge badge_modefil">1</span></li>
										...
										<div class="col-md-12">
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-sm-7"><input id="customerName" class="form-control"></div>
												...
												<div class="form-group">
													...
													<div class="col-sm-2"><input id="custInfoInputAccruedAmount" class="form-control" disabled></div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-6"><input id="custInfoInputRemark" class="form-control"></div>
									...
									<div class="row">
										<div class="col-md-12 tab-modefile">
											<ul id="addressTab" class="nav nav-tabs" role="tablist">
												...
												<li role="presentation" class="">
													<div class="checkbox" style="margin-left: 20px"><label> &nbsp;<input id="splitReceiptDocument" type="checkbox" value="true">แยกใบเสร็จรับเงิน/ใบกำกับภาษีตามใบแจ้งค่าใช้บริการ</label></div>
												</li>
											</ul>
											<div class="tab-content">
												<div role="tabpanel" class="tab-pane active" id="tab1"><textarea id="receiptAddress" class="form-control textarea-tab"></textarea></div>
			...
			<div id="detailsPanel" class="hide row">
				<div class="col-md-12 tab-modefile">
					<ul id="invoiceDetailsTab" class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" class=""><a href="#tab-2-3" aria-controls="tab-2-3" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-tasks"></span> รายการเปลี่ยนแปลง</a></li>
					</ul>
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="tab-2-1">
							<table id="invoiceList" name="tableinvoiceheader" class="table table-hover" data-toggle="table" data-detail-view="true" data-detail-formatter="invoiceServiceFormatter" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
								<thead>
									<tr>
										<th data-field="checked" data-checkbox="true">&nbsp;</th>
										<th data-field="invoiceNo" data-align="center" data-sortable="true">เลขที่ใบแจ้ง<br>ค่าใช้บริการ</th>
										<th data-field="issueDt" data-align="center" data-sortable="true">วันจัดทำใบแจ้ง<br>ค่าใช้บริการ</th>
										<th data-field="dueDt" data-align="center" data-sortable="true">วันครบ<br>กำหนด</th>
										...
										<th data-field="balanceDue" data-sortable="true" data-align="right" data-formatter="moneyInputFormatter">ยอดชำระ</th>
						...
						<div role="tabpanel" class="tab-pane" id="tab-2-2">
							<table id="historyList" data-toggle="table" data-classes="table table-hover table-striped">
								<thead>
									<tr>
										...
										<th data-field="totalCharge" data-align="right" data-formatter="numberFormatter">ยอดเงินตามใบแจ้ง<br>ค่าบริการ</th>
										<th data-field="payMethod">วิธีการ<br>รับชำระ</th>
										<th data-field="payType">ประเภทการ<br>รับชำระ</th>
						...
						<div role="tabpanel" class="tab-pane" id="tab-2-3">
							<table id="changeList" data-row-style="rowStyle" data-toggle="table" data-classes="table table-hover table-striped">
								<thead>
									<tr>
										...
										<th data-field="user">ผู้รับชำระ</th>
										<th data-field="payType">ประเภทการชำระ</th>
										<th data-field="billCycle">รอบการใช้งาน</th>
										<th data-field="status">สถานะ</th>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-horizontal">
								<div class="form-group">
									<label class="control-label col-sm-2" ><input type="checkbox" id="advancedCheckbox" name="advancedCheckbox" disabled>&nbsp;&nbsp;&nbsp;รับชำระเงินล่วงหน้า</label>
									...
									<div class="col-sm-2"><input id="balance" class="form-control text-right" disabled></div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<label class="control-label col-sm-3"><input type="checkbox" id="checkboxAdditionalDiscount" name="discountCheckbox" disabled>&nbsp;&nbsp;ลูกค้ารับภาระภาษี &nbsp;&nbsp;<span class="glyphicon glyphicon-lock"></span>&nbsp;ส่วนลด :</label>
									...
									<div role="tabpanel" class="tab-pane" id="messages">
										<div class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select class="form-control" id="advSrcCusType"></select>
												</div>
												<div class="col-sm-5">
...
var view = (function($){
	...
	self.input = new(function(){
		...
		that.advSrcCusType = new DropDown("#advSrcCusType").init("../findCustomerSegmentList.json");
	...
	self.custInfoInputRemark = new Input("#custInfoInputRemark");
...
function advanceSearchClickEvent() {
	view.table.advSrcBillNoResultList.clear();
	view.table.advSrcSvcNoResultList.clear();
	view.table.advSrcCusNoResultList.clear();
}
function advSrcBillNoBtnClickEvent() {
	view.dialog.advanceSearchMessageDialog.clear();
	view.table.advSrcBillNoResultList.showLoad();
	view.dialog.advanceSearchMessageDialog.clear().showLoad("System is wait for response CRM data in {timeCnt} seconds.")
	get("../findInvoiceByNo.json", { "invNo": view.input.advSrcBillNo.val() }, function(res){
		view.table.advSrcBillNoResultList.hideLoad().data($.map(res.data, function(o,i){
			return {
				 "acctNo": o.invoiceNo
	...
	}, view.dialog.advanceSearchMessageDialog, function(){ view.table.advSrcBillNoResultList.hideLoad() });
}
function advSrcSvcNoBtnClickEvent() {
	...
	view.dialog.advanceSearchMessageDialog.clear();
	if (svcNo.length < 4) {
		view.dialog.advanceSearchMessageDialog.error(["Please fill 'Service No' at least 4 characters."]).show();
		return;
	}
	view.table.advSrcSvcNoResultList.showLoad();
	function ResponseHandler(res) {
		view.table.advSrcSvcNoResultList.hideLoad().data($.map(res._embedded.billServices, function(o,i){
			return {
				 "propOne": o.propOne
				,"acctNo": o.profile.no
				,"acctName": o.profile.customerAccountName
				,"propLabel": o.propLabel
				,"billGroup": o.profile.billGroup
				,"billNo": o.profile.no
			};
		}));
	}
	if (isProp1 && isProp2) {
		get("../service/bill-svcs/search/both", { "label": view.input.advSrcSvcType.val(), "one": svcNo, "two": svcNo }, ResponseHandler, view.dialog.advanceSearchMessageDialog, function(){ view.table.advSrcSvcNoResultList.hideLoad() });
	} else if (isProp1) {
		get("../service/bill-svcs/search/one", { "label": view.input.advSrcSvcType.val(), "one": svcNo }, ResponseHandler, view.dialog.advanceSearchMessageDialog, function(){ view.table.advSrcSvcNoResultList.hideLoad() });
	} else if (isProp2) {
		get("../service/bill-svcs/search/two", { "label": view.input.advSrcSvcType.val(), "two": svcNo }, ResponseHandler, view.dialog.advanceSearchMessageDialog, function(){ view.table.advSrcSvcNoResultList.hideLoad() });
	} else {
		view.table.advSrcSvcNoResultList.hideLoad();
		view.dialog.advanceSearchMessageDialog.error(["Please select 'Property1' or 'Property2' before proceed to search data."]).show();
	}
}
function advSrcCusNoBtnClickEvent() {
	view.dialog.advanceSearchMessageDialog.clear();
	var url = "", params;
	if (!view.input.advSrcCusNo.empty())         { url = "../service/bill-profiles/search/no"; params = { "no": view.input.advSrcCusNo.val() } }
	else if (!view.input.advSrcCusTaxId.empty()) { url = "../service/bill-profiles/search/tax"; params = { "tax": view.input.advSrcCusTaxId.val() } }
	else if (!view.input.advSrcCusFirstName.empty() || !view.input.advSrcCusLastName.empty()) {
		url = "../service/bill-profiles/search/name"; params = { "firstName": view.input.advSrcCusFirstName.val(), "lastName": view.input.advSrcCusLastName.val() }
	}
	else if (!view.input.advSrcOrgName.empty())  { url = "../service/bill-profiles/search/org"; params = { "org": view.input.advSrcOrgName.val() } }
	else { view.dialog.advanceSearchMessageDialog.error(["Please fill in customer details at least 1 input."]).show(); return; }
	view.table.advSrcCusNoResultList.showLoad();
	view.dialog.advanceSearchMessageDialog.clear().showLoad("System is wait for response CRM data in {timeCnt} seconds.")
	get(url, params, function(res){
		view.table.advSrcCusNoResultList.hideLoad().data($.map(!res._embedded ? [res] : res._embedded.billProfiles, function(o,i){
			console.log(o);
			return {
				 "acctNo": o.no
				,"customerId": o.no
	...
	}, view.dialog.advanceSearchMessageDialog, function(){ view.table.advSrcCusNoResultList.hideLoad() });
}
function addPaymentClickEvent() {
	...
	for (var i = 0, m = invoiceList.length; i < m; i++) {
		var invoice = invoiceList[i], checked = invoice[1], balanceDue = stripToNumber(invoice[9]), received = stripToNumber(invoice[10]);
		if (checked == "on" && subtract(balanceDue, received) < 0) {
...
function buildBillingList() {
	...
	var billingList = view.session("billingList"), bill, invoice, data = view.table.invoiceList.data();
	...
	bill.remark = view.custInfoInputRemark.val();
	...
	for (var i = 0, m = data.length; i < m; i++) {
		...
		invoice.balanceDue = stripToNumber(data[i][9]);
		invoice.received = stripToNumber(data[i][10]);
		invoice.deduction = stripToNumber(data[i][11]);
		invoice.billCycle = data[i][12];
		invoice.status = data[i][13];
	...
	if (isPrepaid) {
		var received = view.advancedAmount.val(), vatRate = stripToNumber(view.custInfoInputVatRate.val()), vat = calculateVatFromIncluded(received, vatRate), charge = received - vat;
		invoice = find(bill.invoiceList, "no", { "no": "-" });
...
function searchClickEvent() {
	...
	view.dialog.mainMessageDialog.clear().showLoad("System is wait for response CRM data in {timeCnt} seconds.")
	...
	get("../service/bill-profiles/search/no", { "no": (window.billNoSelected = billNo) }, function(res) {
		...
		view.dialog.summaryPanel.show(1300);
		...
		console.log("profile._links.customer.href["+profile._links.customer.href+"]");
		// http://localhost:8080/epis/service/bill-profiles/881C00F2784027BCE04400144F67BEE6/customer
		get(profile._links.customer.href, {}, function(customer){
			...
			get("../findInvoiceList.json", { "no": view.input.billNo.val() }, function(res){
				var invoiceData = $.map(res.data, invoiceListMapper);
				...
				get("../findWriteOffInvoiceList.json", { "no": view.input.billNo.val() }, function(res){
					var writeOffInvoiceData = $.map(res.data, writeOffInvoiceListMapper);
				...
				}, view.dialog.mainMessageDialog, function(res){ view.table.invoiceList.hideLoad(); });
				
			}, view.dialog.mainMessageDialog)
			
		}, view.dialog.mainMessageDialog, function(){ view.dialog.mainMessageDialog.stopLoad() });
	}, view.dialog.mainMessageDialog)
}
...
function invoiceListMapper(o) {
	...
	return {
		...
		,"discount": parseFloat((o.totalAdj || 0), 10)
		,"vat": parseFloat(o.taxAmount, 10)
		,"vatRate": parseFloat(o.taxRate || "0", 10)
...
function writeOffInvoiceListMapper(o) {
	...
	return {
		...
		,"amount": parseFloat(o.amountBeforeTax, 10)
		,"charge": parseFloat(o.amountBeforeTax, 10) - parseFloat((o.discount || 0), 10)
		,"discount": parseFloat((o.discount || 0), 10)
		,"vat": parseFloat(o.taxAmount, 10)
		,"vatRate": parseFloat(o.taxRate || "0", 10)
		,"totalCharge": parseFloat(o.amountAfterTax, 10)
		,"balanceDue": parseFloat(o.balanceDue, 10)
...
function invoiceServiceFormatter(val, row, ind) {
	...
	$.get("../findProduct.json", { "no": row.invoiceNo }, function(res){
		loadPanel.finish(Mustache.render($('#template').html(), { "invoices": $.map(res.data, function(o, i){
			return { "productCode": o.productCode, "productName": o.productName, "subProductCode": o.subProductCode, "subProductName": o.subProductName, "revTypeName": o.revTypeName, "amount": view.utils.numberFormat(o.amount) }
		}) }));
	});
	return loadPanel;
}
...
function calculate() {
	...
	var sumVat = 0, sumReceived = 0, sumDeduct = 0;
	for (var i = 0, m = data.length; i < m; i++) {
		var checked = data[i][1] == "on", invoiceNo = data[i][2];
		var vatRate = invoiceMap[invoiceNo] == null ? 7 : invoiceMap[invoiceNo].vatRate;
		var balanceDue = stripToNumber(data[i][9]), received = stripToNumber(data[i][10]), vat = stripToNumber(data[i][7]), deduct = stripToNumber(data[i][11]);
		if (!checked) continue;
		/*if (balanceDue != received)*/ vat = calculateVatFromIncluded(received, vatRate);
		sumReceived += received;
		sumVat += vat;
		sumDeduct += deduct;
	}
	view.input.balance.val(sumReceived - sumVat);
	view.input.vat.val(sumVat);
	view.input.totalCharge.val(sumReceived);
	view.input.deduct.val(sumDeduct);
	view.button.addPayment.disable(totalCharge <= 0);
}
