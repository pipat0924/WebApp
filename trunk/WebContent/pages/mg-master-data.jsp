                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab_1">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ชื่อกลุ่ม (Group Key) :</label>
                                            <div class="col-sm-2">
<!--                                                 <select class="form-control" id="groupKeyCrt"></select> -->
												<input class="form-control" id="groupKeyCrt" name="groupKeyCrt">
                                            </div>
                                            <label class="control-label col-sm-2">รหัส (Key) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="keyCrt" name="keyCrt"></div>
                                            <div class="col-sm-4"><a id="generateIdocFileBtn" class="btn btn-primary"><span class="glyphicon glyphicon-file"></span> Generate IDOC File</a></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ค่าของข้อมูล (Value) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="valueCrt" name="valueCrt"></div>
                                            <div class="col-sm-4"><a id="generateFileBtn" class="btn btn-primary"><span class="glyphicon glyphicon-file"></span> Generate Credit Limit File</a></div>
                                            <div class="col-sm-4">
...
<!--                                                 <select class="form-control" id="groupKey" name="groupKey"></select> -->
                                            ...
                                            <label class="control-label col-sm-2">ลำดับ (Ordering) :</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ค่าเพิ่มเติม 1 (Property 1) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="property1" name="property1"></div>
                                            <label class="control-label col-sm-2">ค่าเพิ่มเติม 2 (Property 2) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="property2" name="property2"></div>
                                            <div class="col-sm-4"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ค่าเพิ่มเติม 3 (Property 3) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="property3" name="property3"></div>
                                            <label class="control-label col-sm-2">ค่าเพิ่มเติม 4 (Property 4) :</label>
                                            <div class="col-sm-2"><input class="form-control" id="property4" name="property4"></div>
                                            <div class="col-sm-4"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ค่าเพิ่มเติม 5 (Property 5) :</label>
...
//     var groupKeyCrt = new Listbox("#groupKeyCrt").init("../MasterData/getGroupData?key=PAYTYPE");
    ...
    var generateFileBtn = new Button("#generateFileBtn");
    var generateIdocFileBtn = new Button("#generateIdocFileBtn");
    ...
    function generateFileBtnOnClick(){
    	$.ajax({
            type: "POST",
            url: "../MasterData/generateCreditlimitFile",
//             data: JSON.stringify(dataSend),
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success:function(res){
                alert('Generate File Successed.');
            },
            error: function(jqxhr) {
            	alert('Generate File has error.');
            }
        });
    }
    function generateIdocFileBtnOnClick(){
    	$.ajax({
            type: "POST",
            url: "../MasterData/generateIdocFile",
//             data: JSON.stringify(dataSend),
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success:function(res){
