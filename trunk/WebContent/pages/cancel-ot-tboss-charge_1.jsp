        ...
        <section class="container-fluid menu">
            ...
            <div class="row">
                <div class="col-md-12 tab-modefile">
                	<ol class="breadcrumb">
                        <li><i>ยกเลิกรับชำระค่าบริการหนี้สูญ TBoss และหน๊้นอก TBoss</i></li>
		                                ...
		                                <div class="col-md-12">
		                                    <div class="form-horizontal">
		                                        <div class="form-group">
		                                        	 ...
		                                        	 <div class="col-sm-2"><select id="sourec" class="form-control">
		                                        	 <option value="0">ทั้งหมด</option>
		                                        	 <option value="1">หนี้ TBoss</option>
		                                        	 <option value="2">หนี้ นอก TBoss</option>
		                                        	 </select></div>
            ...
            <ul class="hide list-inline pull-right" id="panelNavigation1">
                <li><a id="addCancelReceiptList" href="cancel-ot-tboss-charge_2.jsp" class="btn btn-link"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มรายการการยกเลิก</a></li>
            ...
            <div class="hide row" id="panelCancelReceiptList1">
	                <!-- Tab panes -->
	                    ...
	                    <div role="tabpanel" class="tab-pane active" id="tab-2-1">
	                        <table id="tableCancelReceiptList1" data-toggle="table" data-detail-view="true" data-detail-formatter="invoiceDetailsFormatter" data-pagination="true" data-page-size="5" data-page-list="[5, 10, 20, 50, 100, 200]" data-cache="false">
	                            <thead>
	                                <tr>
...
function searchClickEvent(res){
	...
	var sourecNo = parseInt($("#sourec").val());
	...
	view.session("sourceNo", sourecNo);
	var url = "", params = {};
    url = "../searchCancelOTTBoss.json"; params = { "invNo": billNo,"no": receiptNo ,"souece" : sourecNo, "payType" : "SERVICE_CHARGE"}
...
function statusFormatter(val, row, ind) {return row.attributes.indexOf("R") > -1 ? "ยกเลิกสำเร็จ" : (row.attributes.indexOf("A") > -1 ? "ปกติ" : "ปกติ") }
...
function buttonProceedReceiptListClickEvent() {
    ...
    view.dialogAuthentication.show().done(function () {
        ...
        location.href = "cancel-ot-tboss-charge_3.jsp";
    });
}
// ---------------------------------------------------------------------
