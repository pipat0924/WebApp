    ...
    <body>
        ...
        <section class="container-fluid menu">
			...
			<ul class="list-inline pull-right list-menu-set">
				<li><a href="pay-ot-tboss-charge_1.jsp?new"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> กลับไปหน้าการรับชำระ</a></li>
			</ul>
			<div class="row">
				<div class="col-md-12">
            ...
            <ul id="navigationPanel" class="list-inline pull-right list-menu-set">
                <li><a href="pay-ot-tboss-charge_2.jsp" class="btn btn-link"><span class="glyphicon glyphicon-th-list"></span> สรุปรายการรับชำระ</a></li>
                                ...
                                <div role="tabpanel" class="tab-pane hide" id="payType11">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3"><input class="form-control text-right" id="exchangeRateInput" value="0.00" readonly></div>
                                        </div>
                                        <div class="form-group">
...
function submitPayment(receiptLang) {
    ...
    */
	...
	while (customer = billingList[custIndex]) {
		...
		params["customers["+ custIndex +"].custNameEdit"] = customer.custNames;
		...
		for (var j = 0, n = customer.invoiceList.length; j < n; j++) {
			...
			params["customers["+ custIndex +"].invoices["+ invoiceIndex +"].change"] = view.input.change.val();;
    ...
    $.ajax({
     ...
     invoice = r.invoices[0]; var invCount = 0;
     custIndex = 0;
     ...
     ,"customerName": customer.custNames
     ...
     ,"invoices": r.invoices.sort(function(a, b){return a.id-b.id})
     });
...
function detailFormatter(val, row, ind) {
	...
	for (var i = 0, m = row.invoices.length; i < m; i++) {
		...
		var billcy = row.invoices[i].billCycle;
// 		 var totaldate = billcy.substring(6,8);
		if(billcy != null){
	        var year = billcy.substring(0, 4);
	        var mount = billcy.substring(4, 6);
		}
		details += '<tr>'
		...
		+ '<td class="text-center">'+ mount + " / " + year+'</td>'
		+ '</tr>';
	}
