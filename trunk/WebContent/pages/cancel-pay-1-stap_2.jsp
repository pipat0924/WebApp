...
<body>
    ...
    <%-- <%@include  file="menu.jsp" %> --%>
	    ...
	    <ul id="navigatePanel" class="list-inline pull-right list-menu-set">
	        <li><a id="addCancelReceiptList" href="cancel-pay-1-stap_1.jsp" class="btn btn-link"><span class="glyphicon glyphicon-arrow-left"></span> กลับไปเพิ่มรายการ</a></li>
	        <li><a href="#requiredApprovalPanel" data-toggle="modal"><span class="glyphicon glyphicon-remove-sign"></span> เลือกรายการการยกเลิก</a></li>
	        <li style="padding-left:22px;"></li>	
	    </ul>
	    <!--------------------------------------->
		<div class="row">
			<div class="col-md-12">
				<div class="panel-heading"><h3 class="panel-title"><span class="glyphicon glyphicon-shopping-cart"></span> รายการรับชำระ</h3></div>
	...
	<div id="requiredApprovalPanel" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
							<div class="col-md-12">
								<div class="form-horizontal">
                                  	<div class="form-group">
                                      <label class="control-label col-sm-4">ผู้อนุมัติ  :</label>
                                      <div class="col-sm-6">
				...
				<div class="modal-footer">
					<a id="approvalBtn" class="btn btn-success"><span class="glyphicon glyphicon-ok-circle"></span> ตกลง</a>
...
view.input.cancelReasonType.data([{ key: "customerRequest", value: " - กรุณาเลือกข้อมูล - "},{ key: "wrongInformation", value: "ชื่อ-ที่อยู่ผิด"},{ key: "wrongTransaction", value: "ชำระผิดรายการ" }]);
